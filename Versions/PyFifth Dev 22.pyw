...
class CharacterSheet:
    def __init__(self, master):
        ...
        self.ProficiencyBonusEntry = EntryInterceptedBindings(self.CharacterSheetHeaderFrame, textvariable=self.ProficiencyBonusEntryVar, state=DISABLED, justify=CENTER, width=5, disabledbackground="light gray", disabledforeground="black",
                                           cursor="arrow")
        ...
        class AbilitiesAndSavingThrowsTable:
            ...
            class AbilitiesAndSavingThrowsEntry:
                def __init__(self, master, AbilityName, List, Row):
                    ...
                    # Total Entry
                    self.AbilityEntryTotal = EntryInterceptedBindings(master, width=3, justify=CENTER, textvariable=self.AbilityEntryTotalVar, state=DISABLED, disabledbackground="light gray", disabledforeground="black", cursor="arrow")
            ...
            class AbilitiesDataConfig:
                def __init__(self, master):
                    ...
                    self.PointBuyEntry = EntryInterceptedBindings(self.Window, state=DISABLED, width=9, disabledbackground="light gray", disabledforeground="black", cursor="arrow", textvariable=self.PointBuyEntryVar, justify=CENTER)
                ...
                class AbilitiesDataConfigEntry:
                    def __init__(self, master, AbilityEntry, AbilityNameShort, List, Row):
                        ...
                        # Total Entry
                        self.AbilityEntryTotal = EntryInterceptedBindings(master, width=9, justify=CENTER, state=DISABLED, disabledforeground="black", disabledbackground="light gray", cursor="arrow", textvariable=self.AbilityTotalVar)
    ...
    class CombatAndFeatures:
        def __init__(self, master):
            ...
            for Index in range(1, 21):
                self.MaxHPData[str(Index)] = StringVar()
            self.MaxHPData["HPPerLevel"] = StringVar()
            self.MaxHPData["HPOverride"] = StringVar()
            ...
            self.MaxHPEntry = EntryInterceptedBindings(self.MaxHPFrame, width=5, justify=CENTER, textvariable=self.MaxHPEntryVar, font=self.VitalityFontSize, state=DISABLED, disabledbackground=GlobalInst.ButtonColor, cursor="arrow",
            ...
            for Tag, Var in self.MaxHPData.items():
                SavingAndOpeningInst.SavedData["MaxHPData" + Tag] = Var
        ...
        class MaxHPMenu:
            def __init__(self, master, MaxHPData):
                ...
                self.HPAtEachLevelFrame.grid(row=0, column=0, sticky=NSEW, padx=2, pady=2, columnspan=2)
                ...
                self.AdditionalHPPerLevelFrame.grid(row=1, column=0, sticky=NSEW, padx=2, pady=2, columnspan=2)
                ...
                self.HPOverrideFrame.grid(row=2, column=0, sticky=NSEW, padx=2, pady=2, columnspan=2)
                ...
                self.SubmitButton.grid(row=3, column=0, sticky=NSEW, padx=2, pady=2)

                # Cancel Button
                self.CancelButton = Button(self.Window, text="Cancel", command=self.Cancel, bg=GlobalInst.ButtonColor)
                self.CancelButton.grid(row=3, column=1, sticky=NSEW, padx=2, pady=2)
        ...
        class SpellList:
            ...
            class SpellListEntry:
                def __init__(self, master, List, LevelName, SortOrderValuesTuple, ScrollingDisabledVar, Row):
                    ...
                    # Name Entry
                    self.NameEntry = EntryInterceptedBindings(master.WindowFrame, width=42, justify=CENTER, state=DISABLED, disabledbackground=GlobalInst.ButtonColor, disabledforeground="black", textvariable=self.NameEntryVar, cursor="arrow")
    ...
    class Inventory:
        def __init__(self, master):
            ...
            self.TotalLoadEntry = EntryInterceptedBindings(self.LoadsFrame, width=10, justify=CENTER, state=DISABLED, disabledforeground="black", disabledbackground="light gray", textvariable=self.TotalLoadEntryVar, cursor="arrow")
            ...
            self.TreasureLoadEntry = EntryInterceptedBindings(self.LoadsFrame, width=10, justify=CENTER, state=DISABLED, disabledforeground="black", disabledbackground="light gray", textvariable=self.TreasureLoadEntryVar, cursor="arrow")
            ...
            self.TotalValueEntry = EntryInterceptedBindings(self.ValuesFrame, width=10, justify=CENTER, state=DISABLED, disabledforeground="black", disabledbackground="light gray", textvariable=self.TotalValueEntryVar, cursor="arrow")
            ...
            self.GearValueEntry = EntryInterceptedBindings(self.ValuesFrame, width=10, justify=CENTER, state=DISABLED, disabledforeground="black", disabledbackground="light gray", textvariable=self.GearValueEntryVar, cursor="arrow")
            ...
            self.TreasureValueEntry = EntryInterceptedBindings(self.ValuesFrame, width=10, justify=CENTER, state=DISABLED, disabledforeground="black", disabledbackground="light gray", textvariable=self.TreasureValueEntryVar, cursor="arrow")
            ...
            self.MiscValueEntry = EntryInterceptedBindings(self.ValuesFrame, width=10, justify=CENTER, state=DISABLED, disabledforeground="black", disabledbackground="light gray", textvariable=self.MiscValueEntryVar, cursor="arrow")
            ...
            self.CoinValueEntry = EntryInterceptedBindings(self.CoinValueAndWeightHolderFrame, width=13, justify=CENTER, textvariable=self.CoinValueEntryVar, state=DISABLED, disabledforeground="black", disabledbackground="light gray",
                                        cursor="arrow")
            ...
            self.CoinWeightEntry = EntryInterceptedBindings(self.CoinValueAndWeightHolderFrame, width=13, justify=CENTER, textvariable=self.CoinWeightEntryVar, state=DISABLED, disabledforeground="black", disabledbackground="light gray",
                                         cursor="arrow")
        ...
        class SpendCoinsMenu:
            def __init__(self, master, Coins):
                ...
                self.MatchValuesAfterSpendingEntry = EntryInterceptedBindings(self.MatchValuesFrame, textvariable=self.MatchValuesAfterSpendingEntryVar, width=20, state=DISABLED, disabledforeground="black", disabledbackground="light gray",
                                                           cursor="arrow", justify=CENTER)
                self.MatchValuesAfterSpendingEntry.grid(row=1, column=0, sticky=NSEW, padx=2, pady=2)
                self.MatchValuesComparatorEntry = EntryInterceptedBindings(self.MatchValuesFrame, textvariable=self.MatchValuesComparatorEntryVar, width=5, state=DISABLED, disabledforeground="black", disabledbackground="lightgray", cursor="arrow",
                                                        justify=CENTER)
                ...
                self.MatchValuesRemainingEntry = EntryInterceptedBindings(self.MatchValuesFrame, textvariable=self.MatchValuesRemainingEntryVar, width=20, state=DISABLED, disabledforeground="black", disabledbackground="light gray",
                                                       cursor="arrow", justify=CENTER)
        ...
        class SupplyDisplay:
            def __init__(self, master, ConsumptionRateDefault, Tag):
                ...
                # Entries
                self.LoadEntry = EntryInterceptedBindings(self.SupplyDisplayFrame, textvariable=self.LoadEntryVar, width=10, justify=CENTER, state=DISABLED, disabledforeground="black", disabledbackground="light gray", cursor="arrow")
                self.LoadEntry.grid(row=0, column=1, sticky=NSEW)
                self.DaysEntry = EntryInterceptedBindings(self.SupplyDisplayFrame, textvariable=self.DaysEntryVar, width=10, justify=CENTER, state=DISABLED, disabledforeground="black", disabledbackground=GlobalInst.ButtonColor, cursor="arrow")
...
class CoinCalculator:
    def __init__(self, master, DialogMode=False):
        ...
        self.WeightOutputEntry = EntryInterceptedBindings(self.TableFrame, textvariable=self.WeightOutputEntryVar, justify=CENTER, width=20, state=DISABLED, disabledforeground="black", disabledbackground="light gray", cursor="arrow")
...
class ScrolledText:
    def __init__(self, master, Width=100, Height=100, Disabled=False, DisabledBackground="light gray", FontSize=None, TrackChanges=True):
        self.Width = Width
        self.Height = Height
