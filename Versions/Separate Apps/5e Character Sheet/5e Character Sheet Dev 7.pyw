...
def UpdateStatsAndInventory():
    ...
    for Ability in StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.SpellcastingInst.SpellcastingAbilitiesList:
        SpellcastingAbility = Ability.SpellcastingAbilitySelectionDropdownVar.get()
        SpellcastingAbilityModifier = 0
        SpellAttackModifierManualBonus = GetStringVarAsInt(Ability.SpellAttackModifierManualBonusVar)
        SpellSaveDCManualBonus = GetStringVarAsInt(Ability.SpellSaveDCManualBonusVar)
...
def UpdateWindowTitle():
    ...
    if CharacterName != "":
        CharacterName += " - "
    root.wm_title(CharacterName + "Character Sheet" + CurrentOpenFile)
...
def ConfigureBindings():
    ...
    ToolbarAndStatusBarInst.UpdateStatsButton.bind("<Leave>", ToolbarAndStatusBarInst.ToolbarRevertToStatusEvent)
    ...
    # Inventory Scrolling
    StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.InventoryInst.InventoryListScrolledCanvas.WindowFrame.bind("<Enter>",
                                                                                                                               StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.InventoryInst.InventoryListScrolledCanvas.BindMouseWheel)
    StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.InventoryInst.InventoryListScrolledCanvas.WindowFrame.bind("<Leave>", UnbindMouseWheel)
    ...
    ToolbarAndStatusBarInst.ToolbarSaveButton.bind("<Leave>", ToolbarAndStatusBarInst.ToolbarRevertToStatusEvent)
    ToolbarAndStatusBarInst.ToolbarSaveAsButton.bind("<Leave>", ToolbarAndStatusBarInst.ToolbarRevertToStatusEvent)
    ToolbarAndStatusBarInst.ToolbarOpenButton.bind("<Leave>", ToolbarAndStatusBarInst.ToolbarRevertToStatusEvent)
    ...
    StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.AbilitiesAndSkillsInst.PassivePerceptionEntry.bind("<Leave>", ToolbarAndStatusBarInst.ToolbarRevertToStatusEvent)
    StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.AbilitiesAndSkillsInst.PassiveInvestigationEntry.bind("<Leave>", ToolbarAndStatusBarInst.ToolbarRevertToStatusEvent)
    # AC Tooltip
    ...
    StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.CombatAndFeaturesInst.ACEntry.bind("<Leave>", ToolbarAndStatusBarInst.ToolbarRevertToStatusEvent)
    ...
    StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.CombatAndFeaturesInst.InitiativeEntry.bind("<Leave>", ToolbarAndStatusBarInst.ToolbarRevertToStatusEvent)
    ...
    for Entry in StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.CombatAndFeaturesInst.FeaturesInst.FeaturesEntriesList:
        ...
        Entry.NameEntry.bind("<Leave>", ToolbarAndStatusBarInst.ToolbarRevertToStatusEvent)

    # Spellcasting Tooltips
    for Ability in StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.SpellcastingInst.SpellcastingAbilitiesList:
        Ability.SpellSaveDCEntry.bind("<Enter>", StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.SpellcastingInst.SpellSaveDCTooltipSet)
        Ability.SpellSaveDCEntry.bind("<Leave>", ToolbarAndStatusBarInst.ToolbarRevertToStatusEvent)
        Ability.SpellAttackModifierEntry.bind("<Enter>", StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.SpellcastingInst.SpellAttackModifierTooltipSet)
        Ability.SpellAttackModifierEntry.bind("<Leave>", ToolbarAndStatusBarInst.ToolbarRevertToStatusEvent)
    ...
    StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.SpellcastingInst.SpellPointsMaxEntry.bind("<Leave>", ToolbarAndStatusBarInst.ToolbarRevertToStatusEvent)
    ...
    StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.SpellcastingInst.SpellPointsRemainingEntry.bind("<Leave>", ToolbarAndStatusBarInst.ToolbarRevertToStatusEvent)
    ...
    class CharacterStatsInventoryAndNotes:
        ...
        class AbilitiesAndSkills:
            def __init__(self, master):
                ...
                CharacterData["JackOfAllTradesBoxVar"] = self.JackOfAllTradesBoxVar
                CharacterData["RemarkableAthleteBoxVar"] = self.RemarkableAthleteBoxVar
            ...
            class AbilitiesAndSavingThrowsTable:
                def __init__(self, master):
                    ...
                    self.AbilitiesNotes = ScrolledText(self.AbilitiesNotesFrame, Width=260, Height=150)
                ...
                class AbilitiesAndSavingThrowsEntry:
                    ...
                    def ConfigureTooltipBindings(self):
                        ...
                        self.AbilityEntryModifier.bind("<Leave>", ToolbarAndStatusBarInst.ToolbarRevertToStatusEvent)
                        self.AbilitySavingThrowModifier.bind("<Enter>", self.ToolbarAbilityRollTooltipSet)
                        self.AbilitySavingThrowModifier.bind("<Leave>", ToolbarAndStatusBarInst.ToolbarRevertToStatusEvent)
                    ...
                    def RollAbility(self, event):
                        BaseModifier = GetStringVarAsInt(self.AbilityEntryModifierVar)
                        JackOfAllTradesModifier = BaseModifier
                        RemarkableAthleteModifier = BaseModifier
                        ProficiencyBonus = GetStringVarAsInt(CharacterSheetHeaderInst.ProficiencyBonusEntryVar)
                        AbilityName = self.AbilityNameVar.get()
                        if StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.AbilitiesAndSkillsInst.RemarkableAthleteBoxVar.get():
                        ...
                        if StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.AbilitiesAndSkillsInst.JackOfAllTradesBoxVar.get():
                        ...
                        StatsAndDiceRollerFrameInst.DiceRollerInst.ModifierEntryVar.set(str(FinalModifier))
            ...
            class SkillsTable:
                ...
                class SkillsEntry:
                    ...
                    def ConfigureTooltipBindings(self):
                        ...
                        self.ModifierEntry.bind("<Leave>", ToolbarAndStatusBarInst.ToolbarRevertToStatusEvent)
                    ...
                    def RollSkill(self, event):
                        BaseModifier = GetStringVarAsInt(self.TotalModifierVar)
                        JackOfAllTradesModifier = BaseModifier
                        RemarkableAthleteModifier = BaseModifier
                        ProficiencyBonus = GetStringVarAsInt(CharacterSheetHeaderInst.ProficiencyBonusEntryVar)
                        ...
                        if not Proficiency1 and not Proficiency2 and StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.AbilitiesAndSkillsInst.RemarkableAthleteBoxVar.get():
                            if SkillName.endswith("(STR)") or SkillName.endswith("(DEX)") or SkillName.endswith("(CON)"):
                                RemarkableAthleteModifier += math.ceil(ProficiencyBonus / 2)
                        if not Proficiency1 and not Proficiency2 and StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.AbilitiesAndSkillsInst.JackOfAllTradesBoxVar.get():
                            JackOfAllTradesModifier += math.floor(ProficiencyBonus / 2)
                        FinalModifier = max(BaseModifier, RemarkableAthleteModifier, JackOfAllTradesModifier)
        ...
        class Spellcasting:
            ...
            def SpellSaveDCTooltipSet(self, event):
                ToolbarAndStatusBarInst.StatusBarTextVar.set("Right-click on a spell save DC to set a bonus.")

            def SpellAttackModifierTooltipSet(self, event):
                ToolbarAndStatusBarInst.StatusBarTextVar.set("Left-click on a spell attack modifier to roll 1d20 with it.  Right-click to set a bonus.")
            ...
            class SpellcastingAbility:
                def __init__(self, master, List, Column):
                    ...
                    # Spell Save DC
                    self.SpellSaveDCEntry = Entry(master, justify=CENTER, state=DISABLED, disabledbackground=ButtonColor, disabledforeground="black", width=2, textvariable=self.SpellSaveDCEntryVar,
                                                  cursor="arrow")
                    ...
                    self.SpellAttackModifierEntry = Entry(master, justify=CENTER, state=DISABLED, disabledbackground=ButtonColor, disabledforeground="black", width=2,
                    ...
                    # Add Saved Fields to Character Data Dictionary
                    CharacterData["SpellcastingAbilitySelectionDropdownVar" + str(self.Column)] = self.SpellcastingAbilitySelectionDropdownVar
                    CharacterData["SpellAttackModifierManualBonusVar" + str(self.Column)] = self.SpellAttackModifierManualBonusVar
                    CharacterData["SpellSaveDCManualBonusVar" + str(self.Column)] = self.SpellSaveDCManualBonusVar
            ...
            class ExpendOrRestoreSpellPointsMenu:
                def __init__(self, master, Mode):
                    ...
                    # Amount Inputs
                    self.SpellSlotDropdown = ttk.Combobox(self.TableFrame, textvariable=self.SpellSlotDropdownVar, values=("", "1st", "2nd", "3rd", "4th", "5th", "6th", "7th", "8th", "9th"), width=4, state="readonly")
        ...
        class Inventory:
            def __init__(self, master):
                ...
                self.InventoryListScrolledCanvas = ScrolledCanvas(self.InventoryListFrame, Height=325, Width=640, ScrollingDisabledVar=self.ScrollingDisabledVar)
                ...
                # Inventory Entries
                self.InventoryEntry1 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 1)
                self.InventoryEntry2 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 2)
                self.InventoryEntry3 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 3)
                self.InventoryEntry4 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 4)
                self.InventoryEntry5 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 5)
                self.InventoryEntry6 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 6)
                self.InventoryEntry7 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 7)
                self.InventoryEntry8 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 8)
                self.InventoryEntry9 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 9)
                self.InventoryEntry10 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 10)
                self.InventoryEntry11 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 11)
                self.InventoryEntry12 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 12)
                self.InventoryEntry13 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 13)
                self.InventoryEntry14 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 14)
                self.InventoryEntry15 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 15)
                self.InventoryEntry16 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 16)
                self.InventoryEntry17 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 17)
                self.InventoryEntry18 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 18)
                self.InventoryEntry19 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 19)
                self.InventoryEntry20 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 20)
                self.InventoryEntry21 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 21)
                self.InventoryEntry22 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 22)
                self.InventoryEntry23 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 23)
                self.InventoryEntry24 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 24)
                self.InventoryEntry25 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 25)
                self.InventoryEntry26 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 26)
                self.InventoryEntry27 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 27)
                self.InventoryEntry28 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 28)
                self.InventoryEntry29 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 29)
                self.InventoryEntry30 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 30)
                self.InventoryEntry31 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 31)
                self.InventoryEntry32 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 32)
                self.InventoryEntry33 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 33)
                self.InventoryEntry34 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 34)
                self.InventoryEntry35 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 35)
                self.InventoryEntry36 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 36)
                self.InventoryEntry37 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 37)
                self.InventoryEntry38 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 38)
                self.InventoryEntry39 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 39)
                self.InventoryEntry40 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 40)
                self.InventoryEntry41 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 41)
                self.InventoryEntry42 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 42)
                self.InventoryEntry43 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 43)
                self.InventoryEntry44 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 44)
                self.InventoryEntry45 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 45)
                self.InventoryEntry46 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 46)
                self.InventoryEntry47 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 47)
                self.InventoryEntry48 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 48)
                self.InventoryEntry49 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 49)
                self.InventoryEntry50 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 50)
                self.InventoryEntry51 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 51)
                self.InventoryEntry52 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 52)
                self.InventoryEntry53 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 53)
                self.InventoryEntry54 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 54)
                self.InventoryEntry55 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 55)
                self.InventoryEntry56 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 56)
                self.InventoryEntry57 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 57)
                self.InventoryEntry58 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 58)
                self.InventoryEntry59 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 59)
                self.InventoryEntry60 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 60)
                self.InventoryEntry61 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 61)
                self.InventoryEntry62 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 62)
                self.InventoryEntry63 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 63)
                self.InventoryEntry64 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 64)
                self.InventoryEntry65 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 65)
                self.InventoryEntry66 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 66)
                self.InventoryEntry67 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 67)
                self.InventoryEntry68 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 68)
                self.InventoryEntry69 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 69)
                self.InventoryEntry70 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 70)
                self.InventoryEntry71 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 71)
                self.InventoryEntry72 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 72)
                self.InventoryEntry73 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 73)
                self.InventoryEntry74 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 74)
                self.InventoryEntry75 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 75)
                self.InventoryEntry76 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 76)
                self.InventoryEntry77 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 77)
                self.InventoryEntry78 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 78)
                self.InventoryEntry79 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 79)
                self.InventoryEntry80 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 80)
                self.InventoryEntry81 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 81)
                self.InventoryEntry82 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 82)
                self.InventoryEntry83 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 83)
                self.InventoryEntry84 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 84)
                self.InventoryEntry85 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 85)
                self.InventoryEntry86 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 86)
                self.InventoryEntry87 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 87)
                self.InventoryEntry88 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 88)
                self.InventoryEntry89 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 89)
                self.InventoryEntry90 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 90)
                self.InventoryEntry91 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 91)
                self.InventoryEntry92 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 92)
                self.InventoryEntry93 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 93)
                self.InventoryEntry94 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 94)
                self.InventoryEntry95 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 95)
                self.InventoryEntry96 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 96)
                self.InventoryEntry97 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 97)
                self.InventoryEntry98 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 98)
                self.InventoryEntry99 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 99)
                self.InventoryEntry100 = self.InventoryEntry(self.InventoryListScrolledCanvas.WindowFrame, self.InventoryEntriesList, self.ScrollingDisabledVar, 100)
        ...
        class Notes:
            def __init__(self, master):
                ...
                self.NotesField1.ScrolledTextFrame.grid(row=0, column=1, padx=2, pady=2)
                self.NotesField2 = ScrolledText(master, Height=497, Width=220)
                self.NotesField2.ScrolledTextFrame.grid(row=0, column=3, padx=2, pady=2)
                self.NotesField3 = ScrolledText(master, Height=497, Width=220)
                self.NotesField3.ScrolledTextFrame.grid(row=0, column=5, padx=2, pady=2)

                # Add Saved Field to Character Data Dictionary
                CharacterData["NotesField1"] = self.NotesField1
                CharacterData["NotesField2"] = self.NotesField2
                CharacterData["NotesField3"] = self.NotesField3
...
class ToolbarAndStatusBar:
    ...
    def SaveButton(self):
        ...
        if SaveFileName != "":
            ...
            UpdateWindowTitle()
            root.after(1000, self.ToolbarRevertToStatus)
        else:
    ...
    def ToolbarRevertToStatusEvent(self, event):
        if self.StatusBarTextVar.get() != "Saving..." and self.StatusBarTextVar.get() != "Opening...":
            self.ToolbarRevertToStatus()

    def ToolbarRevertToStatus(self):
        self.StatusBarTextVar.set("Status")
