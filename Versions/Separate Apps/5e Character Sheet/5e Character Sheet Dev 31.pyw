        ...
        class FeaturesAndCreatureStats:
            ...
            class FeatureOrCreatureStatsEntry:
                def __init__(self, master, List, ScrollingDisabledVar, SortOrderValuesTuple, Row):
                    ...
                    self.NameEntry.bind("<Shift-Button-1>", self.SetCreatureStats)
                    self.NameEntry.bind("<Control-Button-1>", self.Open)
...
class Global:
    ...
    def ConfigureBindings(self):
        ...
        for Entry in CharacterStatsInventoryAndNotesInst.CombatAndFeaturesInst.FeaturesAndCreatureStatsInst.FeatureOrCreatureStatsEntriesList:
            ToolbarAndStatusBarInst.TooltipConfig(Entry.NameEntry, "Left-click on a feature or creature stats entry to set a feature.  Shift+left-click to set creature stats.  Ctrl+left-click to open from a creature file.")
