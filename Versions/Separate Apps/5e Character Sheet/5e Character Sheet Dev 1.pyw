            ...
            class AbilitiesAndSavingThrowsTable:
                ...
                class AbilitiesAndSavingThrowsEntry:
                    ...
                    def RollAbility(self, event):
                        ...
                        StatsAndDiceRollerFrameInst.DiceRollerInst.ModifierEntryVar.set(self.AbilityEntryModifierVar.get())
                        StatsAndDiceRollerFrameInst.DiceRollerInst.Roll(self.AbilityNameVar.get() + " Ability Check:\n")

                    def RollSavingThrow(self, event):
                        StatsAndDiceRollerFrameInst.DiceRollerInst.DiceNumberEntryVar.set(1)
                        StatsAndDiceRollerFrameInst.DiceRollerInst.DieTypeEntryVar.set(20)
                        StatsAndDiceRollerFrameInst.DiceRollerInst.ModifierEntryVar.set(self.AbilitySavingThrowModifierVar.get())
            ...
            class SkillsTable:
                ...
                class SkillsEntry:
                    ...
                    def RollSkill(self, event):
                        StatsAndDiceRollerFrameInst.DiceRollerInst.DiceNumberEntryVar.set(1)
                        StatsAndDiceRollerFrameInst.DiceRollerInst.DieTypeEntryVar.set(20)
                        StatsAndDiceRollerFrameInst.DiceRollerInst.ModifierEntryVar.set(self.TotalModifierVar.get())
...
class ToolbarAndStatusBar:
    ...
    def SaveInventory(self, TextFile):
        # Save Inventory Coins
        self.SaveVar(TextFile, StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.InventoryInst.CoinsEntryCPVar, "InventoryCP")
        self.SaveVar(TextFile, StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.InventoryInst.CoinsEntrySPVar, "InventorySP")
        self.SaveVar(TextFile, StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.InventoryInst.CoinsEntryEPVar, "InventoryEP")
        self.SaveVar(TextFile, StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.InventoryInst.CoinsEntryGPVar, "InventoryGP")
        self.SaveVar(TextFile, StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.InventoryInst.CoinsEntryPPVar, "InventoryPP")

        # Save Inventory List
        for Entry in StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.InventoryInst.InventoryEntriesList:
            self.SaveVar(TextFile, Entry.NameEntryVar, "InventoryListName" + str(Entry.Row))
            self.SaveVar(TextFile, Entry.CountEntryVar, "InventoryListCount" + str(Entry.Row))
            self.SaveVar(TextFile, Entry.UnitWeightEntryVar, "InventoryListUnitWeight" + str(Entry.Row))
            self.SaveVar(TextFile, Entry.UnitValueEntryVar, "InventoryListUnitValue" + str(Entry.Row))
            self.SaveVar(TextFile, Entry.UnitValueDenominationVar, "InventoryListUnitValueDenomination" + str(Entry.Row))
            self.SaveVar(TextFile, Entry.CategoryTagVar, "InventoryListCategoryTag" + str(Entry.Row))
