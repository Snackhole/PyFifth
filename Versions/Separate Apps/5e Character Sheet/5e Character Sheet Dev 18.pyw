...
class Global:
    ...
    def Settings(self):
        ...
        # Create Config Window and Wait
        SettingsMenuInst = self.SettingsMenu(root, self.SpellcasterBoxVar, self.JackOfAllTradesBoxVar, self.RemarkableAthleteBoxVar, self.ObservantBoxVar, self.LuckyHalflingBoxVar, self.CritRangeEntryVar)
    ...
    class SettingsMenu:
        def __init__(self, master, SpellcasterBoxVar, JackOfAllTradesBoxVar, RemarkableAthleteBoxVar, ObservantBoxVar, LuckyHalflingBoxVar, CritRangeEntryVar):
            # Variables
            self.DataSubmitted = BooleanVar()
            ...
            self.JackOfAllTradesBox.grid(row=1, column=0, padx=2, pady=2, sticky=NSEW)
            ...
            self.RemarkableAthleteBox.grid(row=2, column=0, padx=2, pady=2, sticky=NSEW)

            # Observant Checkbox
            self.ObservantBox = Checkbutton(self.Window, text="Observant", variable=self.ObservantBoxVar)
            self.ObservantBox.grid(row=3, column=0, padx=2, pady=2, sticky=NSEW)
            ...
            self.LuckyHalflingBox.grid(row=4, column=0, padx=2, pady=2, sticky=NSEW)
            ...
            self.CritRangeFrame.grid(row=5, column=0, padx=2, pady=2, sticky=NSEW)
            ...
            self.ButtonsFrame.grid_columnconfigure(0, weight=1)
            self.ButtonsFrame.grid_columnconfigure(1, weight=1)
            self.ButtonsFrame.grid(row=6, column=0, sticky=NSEW)
            self.SubmitButton = Button(self.ButtonsFrame, text="Submit", command=self.Submit, bg=GlobalInst.ButtonColor)
            self.SubmitButton.grid(row=0, column=0, sticky=NSEW, padx=2, pady=2)
            self.CancelButton = Button(self.ButtonsFrame, text="Cancel", command=self.Cancel, bg=GlobalInst.ButtonColor)
            self.CancelButton.grid(row=0, column=1, sticky=NSEW, padx=2, pady=2)
