...
class CharacterSheetHeader:
    def __init__(self, master):
        ...
        GlobalInst.CharacterData["CharacterNameEntryVar"] = self.CharacterNameEntryVar
        GlobalInst.CharacterData["CharacterLevelEntryVar"] = self.CharacterLevelEntryVar
        GlobalInst.CharacterData["CharacterClassEntryVar"] = self.CharacterClassEntryVar
        GlobalInst.CharacterData["CharacterExperienceEntryVar"] = self.CharacterExperienceEntryVar
        GlobalInst.CharacterData["SpellcasterBoxVar"] = self.SpellcasterBoxVar
...
class CharacterStatsInventoryAndNotes:
    ...
    class AbilitiesAndSkills:
        def __init__(self, master):
            ...
            # Add Saved Fields to Character Data Dictionary
            GlobalInst.CharacterData["PassivePerceptionManualBonusEntryVar"] = self.PassivePerceptionManualBonusEntryVar
            GlobalInst.CharacterData["PassiveInvestigationManualBonusEntryVar"] = self.PassiveInvestigationManualBonusEntryVar
            GlobalInst.CharacterData["ProficienciesWeaponsField"] = self.ProficienciesWeaponsField
            GlobalInst.CharacterData["ProficienciesArmorField"] = self.ProficienciesArmorField
            GlobalInst.CharacterData["ProficienciesToolsAndInstrumentsField"] = self.ProficienciesToolsAndInstrumentsField
            GlobalInst.CharacterData["ProficienciesLanguagesField"] = self.ProficienciesLanguagesField
            GlobalInst.CharacterData["ProficienciesOtherField"] = self.ProficienciesOtherField
            GlobalInst.CharacterData["JackOfAllTradesBoxVar"] = self.JackOfAllTradesBoxVar
            GlobalInst.CharacterData["RemarkableAthleteBoxVar"] = self.RemarkableAthleteBoxVar
        ...
        class AbilitiesAndSavingThrowsTable:
            def __init__(self, master):
                ...
                # Add Saved Fields to Character Data Dictionary
                GlobalInst.CharacterData["PointBuyBoxVar"] = self.PointBuyBoxVar
                GlobalInst.CharacterData["AbilitiesNotes"] = self.AbilitiesNotes
            ...
            class AbilitiesAndSavingThrowsEntry:
                def __init__(self, master, AbilityName, List, Row):
                    ...
                    # Add Saved Fields to Character Data Dictionary
                    GlobalInst.CharacterData[AbilityName + "AbilityEntryTotalVar"] = self.AbilityEntryTotalVar
                    GlobalInst.CharacterData[AbilityName + "AbilityBaseVar"] = self.AbilityBaseVar
                    GlobalInst.CharacterData[AbilityName + "AbilityRacialVar"] = self.AbilityRacialVar
                    GlobalInst.CharacterData[AbilityName + "AbilityASIVar"] = self.AbilityASIVar
                    GlobalInst.CharacterData[AbilityName + "AbilityMiscVar"] = self.AbilityMiscVar
                    GlobalInst.CharacterData[AbilityName + "AbilityOverrideVar"] = self.AbilityOverrideVar
                    GlobalInst.CharacterData[AbilityName + "AbilitySavingThrowProficiencyBoxVar"] = self.AbilitySavingThrowProficiencyBoxVar
            ...
            class AbilitiesDataConfig:
                def __init__(self, master):
                    ...
                    # Entries
                    self.StrengthConfigEntry = self.AbilitiesDataConfigEntry(self.Window, CharacterStatsInventoryAndNotesInst.AbilitiesAndSkillsInst.AbilitiesAndSavingThrowsInst.StrengthEntry,
                                                                             self.EntriesList, 1)
                    self.DexterityConfigEntry = self.AbilitiesDataConfigEntry(self.Window, CharacterStatsInventoryAndNotesInst.AbilitiesAndSkillsInst.AbilitiesAndSavingThrowsInst.DexterityEntry,
                                                                              self.EntriesList, 2)
                    self.ConstitutionConfigEntry = self.AbilitiesDataConfigEntry(self.Window,
                                                                                 CharacterStatsInventoryAndNotesInst.AbilitiesAndSkillsInst.AbilitiesAndSavingThrowsInst.ConstitutionEntry,
                                                                                 self.EntriesList, 3)
                    self.IntelligenceConfigEntry = self.AbilitiesDataConfigEntry(self.Window,
                                                                                 CharacterStatsInventoryAndNotesInst.AbilitiesAndSkillsInst.AbilitiesAndSavingThrowsInst.IntelligenceEntry,
                                                                                 self.EntriesList, 4)
                    self.WisdomConfigEntry = self.AbilitiesDataConfigEntry(self.Window, CharacterStatsInventoryAndNotesInst.AbilitiesAndSkillsInst.AbilitiesAndSavingThrowsInst.WisdomEntry,
                                                                           self.EntriesList, 5)
                    self.CharismaConfigEntry = self.AbilitiesDataConfigEntry(self.Window, CharacterStatsInventoryAndNotesInst.AbilitiesAndSkillsInst.AbilitiesAndSavingThrowsInst.CharismaEntry,
                                                                             self.EntriesList, 6)

                    # Point Buy
                    self.PointBuyBox = Checkbutton(self.Window, text="Using\nPoint\nBuy", variable=self.PointBuyBoxVar)
        ...
        class SkillsTable:
            ...
            class SkillsEntry:
                def __init__(self, master, SkillName, List, Row):
                    ...
                    # Add Saved Fields to Character Data Dictionary
                    GlobalInst.CharacterData[SkillName + "SkillProficiency1"] = self.ProficiencyBox1Var
                    GlobalInst.CharacterData[SkillName + "SkillProficiency2"] = self.ProficiencyBox2Var
    ...
    class CombatAndFeatures:
        def __init__(self, master):
            ...
            # Add Saved Fields to Character Data Dictionary
            GlobalInst.CharacterData["TempHPEntryVar"] = self.TempHPEntryVar
            GlobalInst.CharacterData["CurrentHPEntryVar"] = self.CurrentHPEntryVar
            GlobalInst.CharacterData["MaxHPEntryVar"] = self.MaxHPEntryVar
            GlobalInst.CharacterData["HitDiceEntryVar"] = self.HitDiceEntryVar
            GlobalInst.CharacterData["HitDiceRemainingEntryVar"] = self.HitDiceRemainingEntryVar
            GlobalInst.CharacterData["DeathSavingThrowsBoxSuccess1Var"] = self.DeathSavingThrowsBoxSuccess1Var
            GlobalInst.CharacterData["DeathSavingThrowsBoxSuccess2Var"] = self.DeathSavingThrowsBoxSuccess2Var
            GlobalInst.CharacterData["DeathSavingThrowsBoxSuccess3Var"] = self.DeathSavingThrowsBoxSuccess3Var
            GlobalInst.CharacterData["DeathSavingThrowsBoxFailure1Var"] = self.DeathSavingThrowsBoxFailure1Var
            GlobalInst.CharacterData["DeathSavingThrowsBoxFailure2Var"] = self.DeathSavingThrowsBoxFailure2Var
            GlobalInst.CharacterData["DeathSavingThrowsBoxFailure3Var"] = self.DeathSavingThrowsBoxFailure3Var
            GlobalInst.CharacterData["ACBaseEntryVar"] = self.ACBaseEntryVar
            GlobalInst.CharacterData["ACModifierVar"] = self.ACModifierVar
            GlobalInst.CharacterData["ACManualBonusEntryVar"] = self.ACManualBonusEntryVar
            GlobalInst.CharacterData["InitiativeManualBonusEntryVar"] = self.InitiativeManualBonusEntryVar
            GlobalInst.CharacterData["SpeedEntryVar"] = self.SpeedEntryVar
            GlobalInst.CharacterData["OffenseNotes.Text"] = self.OffenseNotes
            GlobalInst.CharacterData["DefenseNotes.Text"] = self.DefenseNotes
            GlobalInst.CharacterData["FeaturesNotes"] = self.FeaturesNotes
        ...
        class FeaturesAndCreatureStats:
            ...
            class FeatureOrCreatureStatsEntry:
                def __init__(self, master, List, Row):
                    ...
                    # Add Saved Fields to Character Data Dictionary
                    GlobalInst.CharacterData["FeatureOrCreatureStatsEntryName" + str(self.Row)] = self.NameEntryVar
                    GlobalInst.CharacterData["FeatureEntryDescription" + str(self.Row)] = self.FeatureDescriptionVar
                    GlobalInst.CharacterData["CreatureMaxHPEntryVar" + str(self.Row)] = self.MaxHPEntryVar
                    GlobalInst.CharacterData["CreatureACEntryVar" + str(self.Row)] = self.ACEntryVar
                    GlobalInst.CharacterData["CreatureSpeedEntryVar" + str(self.Row)] = self.SpeedEntryVar
                    GlobalInst.CharacterData["CreatureCREntryVar" + str(self.Row)] = self.CREntryVar
                    GlobalInst.CharacterData["CreatureSkillSensesAndLanguagesFieldVar" + str(self.Row)] = self.SkillSensesAndLanguagesFieldVar
                    GlobalInst.CharacterData["CreatureFeaturesFieldVar" + str(self.Row)] = self.FeaturesFieldVar
                    GlobalInst.CharacterData["CreatureActionsAndReactionsFieldVar" + str(self.Row)] = self.ActionsAndReactionsFieldVar
                    GlobalInst.CharacterData["CreatureInventoryAndNotesFieldVar" + str(self.Row)] = self.InventoryAndNotesFieldVar
                    GlobalInst.CharacterData["CreatureAbilitiesStrengthEntryVar" + str(self.Row)] = self.AbilitiesStrengthEntryVar
                    GlobalInst.CharacterData["CreatureAbilitiesDexterityEntryVar" + str(self.Row)] = self.AbilitiesDexterityEntryVar
                    GlobalInst.CharacterData["CreatureAbilitiesConstitutionEntryVar" + str(self.Row)] = self.AbilitiesConstitutionEntryVar
                    GlobalInst.CharacterData["CreatureAbilitiesIntelligenceEntryVar" + str(self.Row)] = self.AbilitiesIntelligenceEntryVar
                    GlobalInst.CharacterData["CreatureAbilitiesWisdomEntryVar" + str(self.Row)] = self.AbilitiesWisdomEntryVar
                    GlobalInst.CharacterData["CreatureAbilitiesCharismaEntryVar" + str(self.Row)] = self.AbilitiesCharismaEntryVar
                    GlobalInst.CharacterData["CreatureSizeTagsAndAlignmentEntryVar" + str(self.Row)] = self.SizeTagsAndAlignmentEntryVar
    ...
    class Spellcasting:
        def __init__(self, master):
            ...
            # Add Saved Fields to Character Data Dictionary
            GlobalInst.CharacterData["SpellPointsRemainingEntryVar"] = self.SpellPointsRemainingEntryVar
            GlobalInst.CharacterData["SpellNotesField"] = self.SpellNotesField
            GlobalInst.CharacterData["SpellUsingSpellPointsBoxVar"] = self.SpellUsingSpellPointsBoxVar
            GlobalInst.CharacterData["SpellPointsManualBonusVar"] = self.SpellPointsManualBonusVar
        ...
        class SpellcastingAbility:
            def __init__(self, master, List, Column):
                ...
                # Add Saved Fields to Character Data Dictionary
                GlobalInst.CharacterData["SpellcastingAbilitySelectionDropdownVar" + str(self.Column)] = self.SpellcastingAbilitySelectionDropdownVar
                GlobalInst.CharacterData["SpellAttackModifierManualBonusVar" + str(self.Column)] = self.SpellAttackModifierManualBonusVar
                GlobalInst.CharacterData["SpellSaveDCManualBonusVar" + str(self.Column)] = self.SpellSaveDCManualBonusVar
        ...
        class SpellList:
            ...
            class SpellListEntry:
                def __init__(self, master, List, LevelName, Row):
                    ...
                    # Add Saved Fields to Character Data Dictionary
                    GlobalInst.CharacterData["SpellEntryName" + self.LevelName + str(self.Row)] = self.NameEntryVar
                    GlobalInst.CharacterData["SchoolEntryName" + self.LevelName + str(self.Row)] = self.SchoolEntryVar
                    GlobalInst.CharacterData["SpellEntryCastingTime" + self.LevelName + str(self.Row)] = self.CastingTimeVar
                    GlobalInst.CharacterData["SpellEntryRange" + self.LevelName + str(self.Row)] = self.RangeVar
                    GlobalInst.CharacterData["SpellEntryComponents" + self.LevelName + str(self.Row)] = self.ComponentsVar
                    GlobalInst.CharacterData["SpellEntryDuration" + self.LevelName + str(self.Row)] = self.DurationVar
                    GlobalInst.CharacterData["SpellEntryDescription" + self.LevelName + str(self.Row)] = self.DescriptionVar
                    GlobalInst.CharacterData["SpellEntryPrepared" + self.LevelName + str(self.Row)] = self.PreparedBoxVar
        ...
        class SpellSlotsLevel:
            def __init__(self, master, List, SlotLevel, PointValue, Row):
                ...
                # Add Saved Fields to Character Data Dictionary
                GlobalInst.CharacterData[self.SlotLevel + "SlotsEntryVar"] = self.SlotsEntryVar
                GlobalInst.CharacterData[self.SlotLevel + "UsedEntryVar"] = self.UsedEntryVar
        ...
        class ExpendOrRestoreSpellPointsMenu:
            def __init__(self, master, Mode):
                ...
                # Amount Inputs
                self.SpellSlotDropdown = ttk.Combobox(self.Window, textvariable=self.SpellSlotDropdownVar, values=("", "1st", "2nd", "3rd", "4th", "5th", "6th", "7th", "8th", "9th"), width=4, state="readonly")
    ...
    class Inventory:
        def __init__(self, master):
            ...
            # Add Saved Fields to Character Data Dictionary
            GlobalInst.CharacterData["CoinsEntryCPVar"] = self.CoinsEntryCPVar
            GlobalInst.CharacterData["CoinsEntrySPVar"] = self.CoinsEntrySPVar
            GlobalInst.CharacterData["CoinsEntryEPVar"] = self.CoinsEntryEPVar
            GlobalInst.CharacterData["CoinsEntryGPVar"] = self.CoinsEntryGPVar
            GlobalInst.CharacterData["CoinsEntryPPVar"] = self.CoinsEntryPPVar
            GlobalInst.CharacterData["CarryingCapacityManualBonusVar"] = self.CarryingCapacityManualBonusVar
        ...
        class InventoryEntry:
            def __init__(self, master, List, ScrollingDisabledVar, Row):
                ...
                # Add Saved Fields to Character Data Dictionary
                GlobalInst.CharacterData["InventoryListNameEntryVar" + str(self.Row)] = self.NameEntryVar
                GlobalInst.CharacterData["InventoryListCountEntryVar" + str(self.Row)] = self.CountEntryVar
                GlobalInst.CharacterData["InventoryListUnitWeightEntryVar" + str(self.Row)] = self.UnitWeightEntryVar
                GlobalInst.CharacterData["InventoryListUnitValueEntryVar" + str(self.Row)] = self.UnitValueEntryVar
                GlobalInst.CharacterData["InventoryListUnitValueDenominationVar" + str(self.Row)] = self.UnitValueDenominationVar
                GlobalInst.CharacterData["InventoryListCategoryTagVar" + str(self.Row)] = self.CategoryTagVar
    ...
    class Notes:
        def __init__(self, master):
            ...
            GlobalInst.CharacterData["NotesField1"] = self.NotesField1
            GlobalInst.CharacterData["NotesField2"] = self.NotesField2
            GlobalInst.CharacterData["NotesField3"] = self.NotesField3
    ...
    class PersonalityAndBackstory:
        def __init__(self, master):
            ...
            # Add Saved Fields to Character Data Dictionary
            GlobalInst.CharacterData["RaceEntryVar"] = self.RaceEntryVar
            GlobalInst.CharacterData["BackgroundEntryVar"] = self.BackgroundEntryVar
            GlobalInst.CharacterData["AlignmentEntryVar"] = self.AlignmentEntryVar
            GlobalInst.CharacterData["AgeEntryVar"] = self.AgeEntryVar
            GlobalInst.CharacterData["PhysicalAppearanceField"] = self.PhysicalAppearanceField
            GlobalInst.CharacterData["PersonalityTraitsField"] = self.PersonalityTraitsField
            GlobalInst.CharacterData["BondsField"] = self.BondsField
            GlobalInst.CharacterData["IdealsField"] = self.IdealsField
            GlobalInst.CharacterData["FlawsField"] = self.FlawsField
            GlobalInst.CharacterData["BackstoryField"] = self.BackstoryField
    ...
    class Portrait():
        def __init__(self, master):
            ...
            # Add Saved Field to Character Data Dictionary
            GlobalInst.CharacterData["PortraitSelectedVar"] = self.PortraitSelectedVar
...
class DiceRoller:
    ...
    def __init__(self, master):
        ...
        # Add Saved Field to Character Data Dictionary
        GlobalInst.CharacterData["ResultsField"] = self.ResultsField
    ...
    class PresetRolls:
        def __init__(self, master):
            ...
            self.PresetRollsScrolledCanvas = ScrolledCanvas(self.PresetRollsFrame, Height=262, Width=322)
        ...
        class PresetRollEntry:
            def __init__(self, master, List, Row):
                ...
                # Add Saved Fields to Character Data Dictionary
                GlobalInst.CharacterData["PresetRollNameEntryVar" + str(self.Row)] = self.PresetRollNameEntryVar
                GlobalInst.CharacterData["PresetRollDiceNumberEntryVar" + str(self.Row)] = self.PresetRollDiceNumberEntryVar
                GlobalInst.CharacterData["PresetRollDieTypeEntryVar" + str(self.Row)] = self.PresetRollDieTypeEntryVar
                GlobalInst.CharacterData["PresetRollModifierEntryVar" + str(self.Row)] = self.PresetRollModifierEntryVar
                GlobalInst.CharacterData["ConfigSubmitted" + str(self.Row)] = self.ConfigSubmitted
                GlobalInst.CharacterData["StrengthBoxVar" + str(self.Row)] = self.StrengthBoxVar
                GlobalInst.CharacterData["DexterityBoxVar" + str(self.Row)] = self.DexterityBoxVar
                GlobalInst.CharacterData["ConstitutionBoxVar" + str(self.Row)] = self.ConstitutionBoxVar
                GlobalInst.CharacterData["IntelligenceBoxVar" + str(self.Row)] = self.IntelligenceBoxVar
                GlobalInst.CharacterData["WisdomBoxVar" + str(self.Row)] = self.WisdomBoxVar
                GlobalInst.CharacterData["CharismaBoxVar" + str(self.Row)] = self.CharismaBoxVar
                GlobalInst.CharacterData["ProficiencyBoxVar" + str(self.Row)] = self.ProficiencyBoxVar
                GlobalInst.CharacterData["ManualBonusEntryVar" + str(self.Row)] = self.ManualBonusEntryVar
...
class ToolbarAndStatusBar:
    def __init__(self, master):
        ...
        self.ToolbarFrame.grid(row=2, column=0, sticky=NSEW, columnspan=2, padx=2, pady=2)
    ...
    def SaveButton(self):
        ...
        if SaveFileName != "":
            with ZipFile(SaveFileName, mode="w") as SaveFile:
                ...
                PortraitSelected = GlobalInst.CharacterData["PortraitSelectedVar"].get()
                if PortraitSelected:
    ...
    def SaveCharacterData(self, File):
        for Tag, Field in GlobalInst.CharacterData.items():
    ...
    def OpenButton(self):
        ...
        if OpenFileName != "":
            with ZipFile(OpenFileName, mode="r") as OpenFile:
                ...
                if GlobalInst.CharacterData["PortraitSelectedVar"].get():
        ...
        for Line in File:
            if Line != "":
                ...
                for Tag, Field in LoadedLine.items():
                    GlobalInst.CharacterData[Tag].set(Field)
