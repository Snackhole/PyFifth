...
def ConfigureBindings():
    ...
    for Ability in StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.SpellcastingInst.SpellcastingAbilitiesList:
        ...
        Ability.SpellSaveDCEntry.bind("<Leave>", ToolbarAndStatusBarInst.ToolbarRevertToPrevious)
        ...
        Ability.SpellAttackModifierEntry.bind("<Leave>", ToolbarAndStatusBarInst.ToolbarRevertToPrevious)
