...
class CharacterSheet:
    ...
    class CombatAndFeatures:
        def __init__(self, master):
            ...
            self.MaxHPEntry = Entry(self.MaxHPFrame, width=5, justify=CENTER, textvariable=self.MaxHPEntryVar, font=self.VitalityFontSize, state=DISABLED, disabledbackground=GlobalInst.ButtonColor, cursor="arrow",
        ...
        class MaxHPMenu:
            def __init__(self, master, MaxHPData):
                ...
                self.HPAtEachLevelFirstEntry = Entry(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["1"])
                ...
                self.HPAtEachLevelSecondEntry = Entry(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["2"])
                ...
                self.HPAtEachLevelThirdEntry = Entry(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["3"])
                ...
                self.HPAtEachLevelFourthEntry = Entry(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["4"])
                ...
                self.HPAtEachLevelFifthEntry = Entry(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["5"])
                ...
                self.HPAtEachLevelSixthEntry = Entry(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["6"])
                ...
                self.HPAtEachLevelSeventhEntry = Entry(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["7"])
                ...
                self.HPAtEachLevelEighthEntry = Entry(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["8"])
                ...
                self.HPAtEachLevelNinthEntry = Entry(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["9"])
                ...
                self.HPAtEachLevelTenthEntry = Entry(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["10"])
                ...
                self.HPAtEachLevelEleventhEntry = Entry(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["11"])
                ...
                self.HPAtEachLevelTwelfthEntry = Entry(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["12"])
                ...
                self.HPAtEachLevelThirteenthEntry = Entry(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["13"])
                ...
                self.HPAtEachLevelFourteenthEntry = Entry(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["14"])
                ...
                self.HPAtEachLevelFifteenthEntry = Entry(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["15"])
                ...
                self.HPAtEachLevelSixteenthEntry = Entry(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["16"])
                ...
                self.HPAtEachLevelSeventeenthEntry = Entry(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["17"])
                ...
                self.HPAtEachLevelEighteenthEntry = Entry(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["18"])
                ...
                self.HPAtEachLevelNineteenthEntry = Entry(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["19"])
                ...
                self.HPAtEachLevelTwentiethEntry = Entry(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["20"])
                ...
                self.AdditionalHPPerLevelEntry = Entry(self.AdditionalHPPerLevelFrame, textvariable=self.MaxHPData["HPPerLevel"], width=5, justify=CENTER)
                ...
                self.HPOverrideEntry = Entry(self.HPOverrideFrame, textvariable=self.MaxHPData["HPOverride"], width=5, justify=CENTER)
    ...
    class TrackableText(Text):
        def __init__(self, *args, **kwargs):
            ...
            if WindowInst.Mode in ["CreatureDataUtility", "DiceRoller", "EncounterManager", "CharacterSheet", "NPCSheet"]:
                self.bind("<Control-o>", self.OpenButton)
                if WindowInst.Mode is "CharacterSheet":
                    self.bind("<Control-d>", self.UpdateStatsAndInventory)
                if WindowInst.Mode is "NPCSheet":
                    self.bind("<Control-d>", self.UpdateStats)
