    ...
    class Inventory:
        ...
        class InventoryEntry:
            def __init__(self, master, List, ScrollingDisabledVar, SortOrderValuesTuple, Row):
                ...
                StatusBarInst.TooltipConfig(self.NameEntry, "Right-click on the name field to set magic item information.")
...
class ModeSelect(Tk):
    def __init__(self):
        ...
        self.NPCSheetModeButton.grid(row=3, column=0, sticky=NSEW, padx=2, pady=2)
        ...
        self.CoinCalculatorModeButton.grid(row=5, column=0, sticky=NSEW, padx=2, pady=2)
...
if __name__ == "__main__":
    ...
    WindowTitles["NPCSheet"] = "NPC Sheet"
    ...
    if WindowInst.Mode is "CoinCalculator":
        ...
        StatusBarInst = StatusBar(WindowInst)
        SavingAndOpeningInst = SavingAndOpening()
        DiceRollerInst = DiceRoller(WindowInst)
        MenuBarInst = MenuBar(WindowInst)
        SavingAndOpeningInst.TrackModifiedFields()
    elif WindowInst.Mode is "EncounterManager":
        StatusBarInst = StatusBar(WindowInst)
        ...
        StatusBarInst = StatusBar(WindowInst)
        SavingAndOpeningInst = SavingAndOpening()
        CharacterSheetInst = CharacterSheet(WindowInst)
        DiceRollerInst = DiceRoller(WindowInst)
        MenuBarInst = MenuBar(WindowInst)
        SavingAndOpeningInst.TrackModifiedFields()
    elif WindowInst.Mode is "NPCSheet":
