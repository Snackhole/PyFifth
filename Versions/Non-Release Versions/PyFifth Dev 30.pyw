        ...
        for Field in SavingAndOpeningInst.SavedData.values():
            ...
            if WindowInst.Mode is "CharacterSheet":
                ...
                if Field in [Inst["AbilitiesAndSavingThrows"].StrengthEntry.AbilityBaseVar, Inst["AbilitiesAndSavingThrows"].StrengthEntry.AbilityEntryTotalVar, Inst["AbilitiesAndSavingThrows"].DexterityEntry.AbilityBaseVar,
                             Inst["AbilitiesAndSavingThrows"].DexterityEntry.AbilityEntryTotalVar, Inst["AbilitiesAndSavingThrows"].ConstitutionEntry.AbilityBaseVar, Inst["AbilitiesAndSavingThrows"].ConstitutionEntry.AbilityEntryTotalVar, Inst["AbilitiesAndSavingThrows"].IntelligenceEntry.AbilityBaseVar, Inst["AbilitiesAndSavingThrows"].IntelligenceEntry.AbilityEntryTotalVar, Inst["AbilitiesAndSavingThrows"].WisdomEntry.AbilityBaseVar, Inst["AbilitiesAndSavingThrows"].WisdomEntry.AbilityEntryTotalVar, Inst["AbilitiesAndSavingThrows"].CharismaEntry.AbilityBaseVar, Inst["AbilitiesAndSavingThrows"].CharismaEntry.AbilityEntryTotalVar]:
                    Field.set("8")
                    continue
