...
class CreatureData:
    def __init__(self, master):
        ...
        GlobalInst.SavedData["InitiativeEntryNameEntryVar"] = self.NameEntryVar
        GlobalInst.SavedData["InitiativeEntryACEntryVar"] = self.ACEntryVar
        GlobalInst.SavedData["InitiativeEntryMaxHPEntryVar"] = self.MaxHPEntryVar
        GlobalInst.SavedData["InitiativeEntrySizeEntryVar"] = self.SizeEntryVar
        GlobalInst.SavedData["InitiativeEntryTypeAndTagsEntryVar"] = self.TypeAndTagsEntryVar
        GlobalInst.SavedData["InitiativeEntryAlignmentEntryVar"] = self.AlignmentEntryVar
        GlobalInst.SavedData["InitiativeEntrySpeedEntryVar"] = self.SpeedEntryVar
        GlobalInst.SavedData["InitiativeEntryCRAndExperienceEntryVar"] = self.CRAndExperienceEntryVar
        GlobalInst.SavedData["InitiativeEntryAbilitiesStrengthEntryVar"] = self.AbilitiesStrengthEntryVar
        GlobalInst.SavedData["InitiativeEntryAbilitiesDexterityEntryVar"] = self.AbilitiesDexterityEntryVar
        GlobalInst.SavedData["InitiativeEntryAbilitiesConstitutionEntryVar"] = self.AbilitiesConstitutionEntryVar
        GlobalInst.SavedData["InitiativeEntryAbilitiesIntelligenceEntryVar"] = self.AbilitiesIntelligenceEntryVar
        GlobalInst.SavedData["InitiativeEntryAbilitiesWisdomEntryVar"] = self.AbilitiesWisdomEntryVar
        GlobalInst.SavedData["InitiativeEntryAbilitiesCharismaEntryVar"] = self.AbilitiesCharismaEntryVar
        GlobalInst.SavedData["InitiativeEntrySkillSensesAndLanguagesFieldVar"] = self.SkillSensesAndLanguagesField
        GlobalInst.SavedData["InitiativeEntrySavingThrowsFieldVar"] = self.SavingThrowsField
        GlobalInst.SavedData["InitiativeEntryVulnerabilitiesResistancesAndImmunitiesFieldVar"] = self.VulnerabilitiesResistancesAndImmunitiesField
        GlobalInst.SavedData["InitiativeEntrySpecialTraitsFieldVar"] = self.SpecialTraitsField
        GlobalInst.SavedData["InitiativeEntryActionsFieldVar"] = self.ActionsField
        GlobalInst.SavedData["InitiativeEntryReactionsFieldVar"] = self.ReactionsField
        GlobalInst.SavedData["InitiativeEntryInventoryFieldVar"] = self.InventoryField
        GlobalInst.SavedData["InitiativeEntryLegendaryActionsAndLairActionsFieldVar"] = self.LegendaryActionsAndLairActionsField
        GlobalInst.SavedData["InitiativeEntryNotesFieldVar"] = self.NotesField
...
class ToolbarAndStatusBar:
    ...
    def SaveButton(self):
        ...
        if CurrentPath == "":
            SaveFileName = filedialog.asksaveasfilename(filetypes=(("Creature file", "*.crea"), ("All files", "*.*")), defaultextension=".crea", title="Save Creature As")
        else:
    ...
    def OpenButton(self):
        ...
        OpenFileName = filedialog.askopenfilename(filetypes=(("Creature file", "*.crea"), ("All files", "*.*")), defaultextension=".crea", title="Open Creature")
        TextFileName = "Creature Data.txt"
        if OpenFileName != "":
