...
class DiceRoller:
    def __init__(self, master):
        ...
        self.ResultsField = ScrolledText(self.ResultsFieldFrame, Width=431, Height=154, Disabled=True, DisabledBackground=GlobalInst.ButtonColor)
        ...
        # Preset Rolls
        self.PresetRollsInst = self.PresetRolls(self.DiceRollerFrame, self.ResultsField, self.CritRangeEntryVar)
    ...
    class PresetRolls:
        def __init__(self, master, ResultsField, CritRangeEntryVar):
            # Store Parameters
            self.ResultsField = ResultsField
            self.CritRangeEntryVar = CritRangeEntryVar
            ...
            # Scrolled Canvas
            self.PresetRollsScrolledCanvas = ScrolledCanvas(self.PresetRollsFrame, Height=405, Width=418, ScrollingDisabledVar=self.ScrollingDisabledVar)
            ...
            self.DiceRollerFields["CritRangeEntryVar"] = self.CritRangeEntryVar
...
class MenuAndStatusBar:
    ...
    def SaveButton(self, SaveAs=False):
        ...
        if CurrentPath == "" or SaveAs:
            SaveFileName = filedialog.asksaveasfilename(filetypes=(("Encounter file", "*.enc"), ("All files", "*.*")), defaultextension=".enc", title="Save Encounter File")
        else:
