...
class CharacterSheetHeader:
    def __init__(self, master):
        ...
        self.CharacterNameEntry = Entry(self.CharacterSheetHeaderFrame, textvariable=self.CharacterNameEntryVar, justify=CENTER, width=35)
...
class StatsAndDiceRoller:
    ...
    class CharacterStatsInventoryAndNotes:
        def __init__(self, master):
            ...
            self.SpellcastingInst = self.Spells(self.SpellcastingPage)
        ...
        class AbilitiesAndSkills:
            def __init__(self, master):
                ...
                self.ProficienciesWeaponsField = ScrolledTextPixelDim(self.ProficienciesWeaponsFieldFrame, width=130, height=73, wrap=WORD)
                self.ProficienciesWeaponsField.pack()
                ...
                self.ProficienciesArmorField = ScrolledTextPixelDim(self.ProficienciesArmorFieldFrame, width=130, height=73, wrap=WORD)
                self.ProficienciesArmorField.pack()
                ...
                self.ProficienciesToolsAndInstrumentsField = ScrolledTextPixelDim(self.ProficienciesToolsAndInstrumentsFieldFrame, width=130, height=73, wrap=WORD)
                self.ProficienciesToolsAndInstrumentsField.pack()
                ...
                self.ProficienciesLanguagesField = ScrolledTextPixelDim(self.ProficienciesLanguagesFieldFrame, width=130, height=73, wrap=WORD)
                self.ProficienciesLanguagesField.pack()
                ...
                self.ProficienciesOtherField = ScrolledTextPixelDim(self.ProficienciesOtherFieldFrame, width=130, height=73, wrap=WORD)
                self.ProficienciesOtherField.pack()
                ...
                CharacterData["ProficienciesWeaponsField"] = self.ProficienciesWeaponsField.Text
                CharacterData["ProficienciesArmorField"] = self.ProficienciesArmorField.Text
                CharacterData["ProficienciesToolsAndInstrumentsField"] = self.ProficienciesToolsAndInstrumentsField.Text
                CharacterData["ProficienciesLanguagesField"] = self.ProficienciesLanguagesField.Text
                CharacterData["ProficienciesOtherField"] = self.ProficienciesOtherField.Text
            ...
            def ConfigurePassivePerception(self, event):
                ...
                PassivePerceptionDataInst = self.PassivePerceptionData(root, self.PassivePerceptionManualBonusEntryVar)
                root.wait_window(PassivePerceptionDataInst.Window)

                # Handle Values
                if PassivePerceptionDataInst.DataSubmitted.get():
                    self.PassivePerceptionManualBonusEntryVar.set(PassivePerceptionDataInst.ManualBonusEntryVar.get())
            ...
            def ConfigurePassiveInvestigation(self, event):
                ...
                # Create Config Window and Wait
                PassiveInvestigationDataInst = self.PassiveInvestigationData(root, self.PassiveInvestigationManualBonusEntryVar)
                root.wait_window(PassiveInvestigationDataInst.Window)

                # Handle Values
                if PassiveInvestigationDataInst.DataSubmitted.get():
                    self.PassiveInvestigationManualBonusEntryVar.set(PassiveInvestigationDataInst.ManualBonusEntryVar.get())

                # Update Stats and Inventory
                UpdateStatsAndInventory()

            # Passive Perception Data
            class PassivePerceptionData:
                def __init__(self, master, PassivePerceptionManualBonusEntryVar):
                    self.DataSubmitted = BooleanVar()
                    self.ManualBonusEntryVar = StringVar(value=PassivePerceptionManualBonusEntryVar.get())

                    # Create Window
                    self.Window = Toplevel(master)
                    self.Window.wm_attributes("-toolwindow", 1)
                    self.Window.wm_title("Passive Perception Data")
                ...
                def ValidEntry(self):
                    try:
                        ...
                        messagebox.showerror("Invalid Entry", "Passive Perception manual bonus must be a whole number.")
                        return False
                    return True

            # Passive Investigation Data
            class PassiveInvestigationData:
                def __init__(self, master, PassiveInvestigationManualBonusEntryVar):
                    self.DataSubmitted = BooleanVar()
                    self.ManualBonusEntryVar = StringVar(value=PassiveInvestigationManualBonusEntryVar.get())

                    # Create Window
                    self.Window = Toplevel(master)
                    self.Window.wm_attributes("-toolwindow", 1)
                    self.Window.wm_title("Passive Investigation Data")
                ...
                def ValidEntry(self):
                    try:
                        ...
                        messagebox.showerror("Invalid Entry", "Passive Investigation manual bonus must be a whole number.")
                        return False
                    return True
            ...
            class AbilitiesAndSavingThrowsTable:
                def __init__(self, master):
                    ...
                    self.AbilitiesNotes = ScrolledTextPixelDim(self.AbilitiesNotesFrame, width=260, height=200, wrap=WORD)
                    self.AbilitiesNotes.pack()

                    # Add Saved Fields to Character Data Dictionary
                    CharacterData["PointBuyBoxVar"] = self.PointBuyBoxVar
                    CharacterData["AbilitiesNotes"] = self.AbilitiesNotes.Text
        ...
        class CombatAndFeatures:
            def __init__(self, master):
                ...
                self.OffenseNotes = ScrolledTextPixelDim(self.OffenseNotesFrame, height=140, width=330, wrap=WORD)
                ...
                self.DefenseNotes = ScrolledTextPixelDim(self.DefenseNotesFrame, height=140, width=330, wrap=WORD)
                ...
                CharacterData["OffenseNotes.Text"] = self.OffenseNotes.Text
                CharacterData["DefenseNotes.Text"] = self.DefenseNotes.Text
            ...
            class Features:
                def __init__(self, master):
                    ...
                    self.FeaturesFrame.grid(row=1, column=5, rowspan=5, sticky=NSEW, padx=2, pady=2)
                    ...
                    CharacterData["FeaturesNotes"] = self.FeaturesNotes.Text
            ...
            class InitiativeConfig:
                ...
                def ValidEntry(self):
                    try:
                        ...
                        messagebox.showerror("Invalid Entry", "Initiative manual bonus must be a whole number.")
                        return False
                    return True
        ...
        class Spells:
            def __init__(self, master):
                ...
                self.SpellEntriesFrame.grid(row=1, column=1, padx=2, pady=2, sticky=NSEW)

                # Spell Entries Notebook
                self.SpellEntriesNotebook = ttk.Notebook(self.SpellEntriesFrame, height=415)
                ...
                class SpellListEntry:
                    ...
                    class SpellConfig:
                        def __init__(self, master, NameEntryVar, SchoolEntryVar, CastingTimeVar, RangeVar, ComponentsVar, DurationVar, DescriptionVar):
                            ...
                            self.CastingTimeField = ScrolledTextPixelDim(self.CastingTimeFrame, height=34, width=121, wrap=WORD)
                            self.CastingTimeField.pack()
                            ...
                            self.RangeField = ScrolledTextPixelDim(self.RangeFrame, height=34, width=121, wrap=WORD)
                            self.RangeField.pack()
                            ...
                            self.ComponentsField = ScrolledTextPixelDim(self.ComponentsFrame, height=34, width=121, wrap=WORD)
                            self.ComponentsField.pack()
                            ...
                            self.DurationField = ScrolledTextPixelDim(self.DurationFrame, height=34, width=121, wrap=WORD)
                            self.DurationField.pack()
        ...
        class Inventory:
            def __init__(self, master):
                ...
                self.InventoryListScrollingCanvas = Canvas(self.InventoryListFrame, highlightthickness=0, height=325, width=640)
        ...
        class Notes:
            def __init__(self, master):
                ...
                # Add Saved Field to Character Data Dictionary
                CharacterData["NotesField"] = self.NotesField.Text
        ...
        class PersonalityAndBackstory:
            def __init__(self, master):
                ...
                self.PhysicalAppearanceField = ScrolledTextPixelDim(self.PhysicalAppearanceFrame, width=155, height=289, wrap=WORD)
                ...
                self.PersonalityTraitsField = ScrolledTextPixelDim(self.PersonalityTraitsFrame, width=155, height=225, wrap=WORD)
                ...
                self.BondsField = ScrolledTextPixelDim(self.BondsFrame, width=155, height=225, wrap=WORD)
                ...
                self.IdealsField = ScrolledTextPixelDim(self.IdealsFrame, width=155, height=225, wrap=WORD)
                ...
                self.FlawsField = ScrolledTextPixelDim(self.FlawsFrame, width=155, height=225, wrap=WORD)
                ...
                self.BackstoryField = ScrolledTextPixelDim(self.BackstoryFrame, width=155, height=473, wrap=WORD)
                ...
                CharacterData["PhysicalAppearanceField"] = self.PhysicalAppearanceField.Text
                CharacterData["PersonalityTraitsField"] = self.PersonalityTraitsField.Text
                CharacterData["BondsField"] = self.BondsField.Text
                CharacterData["IdealsField"] = self.IdealsField.Text
                CharacterData["FlawsField"] = self.FlawsField.Text
                CharacterData["BackstoryField"] = self.BackstoryField.Text
...
class ToolbarAndStatusBar:
    ...
    def SaveCharacterData(self, File):
        for Tag, Field in CharacterData.items():
            ...
            if FieldType == StringVar:
                File.write(json.dumps({Tag + "StringVar": Field.get()}) + "\n")
            elif FieldType == BooleanVar:
                File.write(json.dumps({Tag + "BooleanVar": Field.get()}) + "\n")
            elif FieldType == ScrolledText:
                File.write(json.dumps({Tag + "TextWidget": Field.get("1.0", "end-1c")}) + "\n")
        ...
        for Line in File:
            if Line != "":
                ...
                for Tag, Field in LoadedLine.items():
                    if Tag.endswith("StringVar"):
                        CharacterData[Tag[:-9]].set(Field)
                    elif Tag.endswith("BooleanVar"):
                        CharacterData[Tag[:-10]].set(Field)
                    elif Tag.endswith("TextWidget"):
                        CharacterData[Tag[:-10]].delete(1.0, END)
                        CharacterData[Tag[:-10]].insert(1.0, Field)
        for Entry in StatsAndDiceRollerFrameInst.DiceRollerInst.PresetRollsInst.PresetRollsList:
...
class ScrolledTextPixelDim(Frame):
    def __init__(self, master, width=0, height=0, **kwargs):
        ...
        self.Text = ScrolledText(self, **kwargs)
