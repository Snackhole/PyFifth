        ...
        class FeaturesAndCreatureStats:
            ...
            class FeatureOrCreatureStatsEntry:
                ...
                def Display(self, Row):
                    ...
                    GlobalInst.SavedData["FeatureOrCreatureStatsEntrySortOrder" + str(self.Row)] = self.SortOrderVar
...
class DiceRoller:
    def __init__(self, master):
        ...
        self.ResultsField = ScrolledText(self.ResultsFieldFrame, Width=383, Height=154, Disabled=True, DisabledBackground=GlobalInst.ButtonColor)
    ...
    class PresetRolls:
        def __init__(self, master):
            ...
            # Scrolled Canvas
            self.PresetRollsScrolledCanvas = ScrolledCanvas(self.PresetRollsFrame, Height=220, Width=370)
...
class ToolbarAndStatusBar:
    def __init__(self, master):
        ...
        self.SettingsButton.grid(row=0, column=4, padx=2, pady=2)
        ...
        self.UpdateStatsButton.grid(row=0, column=5, padx=2, pady=2)
...
class Global:
    def __init__(self):
        ...
        self.SpellcasterBoxVar = BooleanVar()
        self.PortraitBoxVar = BooleanVar()
        ...
        self.CritRangeEntryVar = StringVar()
    ...
    def Settings(self):
        ...
        # Create Config Window and Wait
        SettingsMenuInst = self.SettingsMenu(root, self.SpellcasterBoxVar, self.PortraitBoxVar, self.JackOfAllTradesBoxVar, self.RemarkableAthleteBoxVar, self.ObservantBoxVar, self.LuckyHalflingBoxVar, self.CritRangeEntryVar)
    ...
    class SettingsMenu:
        def __init__(self, master, SpellcasterBoxVar, PortraitBoxVar, JackOfAllTradesBoxVar, RemarkableAthleteBoxVar, ObservantBoxVar, LuckyHalflingBoxVar, CritRangeEntryVar):
            # Variables
            self.DataSubmitted = BooleanVar()
            ...
            self.PortraitBox.grid(row=1, column=0, padx=2, pady=2, sticky=NSEW)
            ...
            self.JackOfAllTradesBox.grid(row=2, column=0, padx=2, pady=2, sticky=NSEW)
            ...
            self.RemarkableAthleteBox.grid(row=3, column=0, padx=2, pady=2, sticky=NSEW)

            # Observant Checkbox
            self.ObservantBox = Checkbutton(self.Window, text="Observant", variable=self.ObservantBoxVar)
            self.ObservantBox.grid(row=4, column=0, padx=2, pady=2, sticky=NSEW)
            ...
            self.LuckyHalflingBox.grid(row=5, column=0, padx=2, pady=2, sticky=NSEW)
            ...
            self.CritRangeFrame.grid(row=6, column=0, padx=2, pady=2, sticky=NSEW)
            ...
            self.ButtonsFrame.grid_columnconfigure(0, weight=1)
            self.ButtonsFrame.grid_columnconfigure(1, weight=1)
            self.ButtonsFrame.grid(row=7, column=0, sticky=NSEW)
            self.SubmitButton = Button(self.ButtonsFrame, text="Submit", command=self.Submit, bg=GlobalInst.ButtonColor)
            self.SubmitButton.grid(row=0, column=0, sticky=NSEW, padx=2, pady=2)
            self.CancelButton = Button(self.ButtonsFrame, text="Cancel", command=self.Cancel, bg=GlobalInst.ButtonColor)
            self.CancelButton.grid(row=0, column=1, sticky=NSEW, padx=2, pady=2)
