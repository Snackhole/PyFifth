...
def ConfigureBindings():
    ...
    # Scrolling
    StatsAndDiceRollerFrameInst.DiceRollerInst.PresetRollsInst.PresetRollsScrolledCanvas.BindEnterAndLeaveToBindMouseWheel()
    StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.CombatAndFeaturesInst.FeaturesAndCreatureStatsInst.FeaturesScrolledCanvas.BindEnterAndLeaveToBindMouseWheel()
    StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.InventoryInst.InventoryListScrolledCanvas.BindEnterAndLeaveToBindMouseWheel()
    ...
    ToolbarAndStatusBarInst.TooltipConfig(StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.AbilitiesAndSkillsInst.PassivePerceptionEntry, "Left-click on Passive Perception to set a manual bonus.")
    ToolbarAndStatusBarInst.TooltipConfig(StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.AbilitiesAndSkillsInst.PassiveInvestigationEntry, "Left-click on Passive Investigation to set a manual bonus.")

    # AC Tooltip
    ToolbarAndStatusBarInst.TooltipConfig(StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.CombatAndFeaturesInst.ACEntry, "Left-click on AC to set data.")

    # Initiative Tooltip
    ToolbarAndStatusBarInst.TooltipConfig(StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.CombatAndFeaturesInst.InitiativeEntry,
                                          "Left-click on the initiative modifier to roll 1d20 with it.  Right-click to set a bonus.")

    # Features Tooltips
    for Entry in StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.CombatAndFeaturesInst.FeaturesAndCreatureStatsInst.FeaturesEntriesList:
    ...
    ToolbarAndStatusBarInst.TooltipConfig(StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.SpellcastingInst.SpellPointsMaxEntry, "Left-click on the spell points max to set a bonus.")
    ToolbarAndStatusBarInst.TooltipConfig(StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.SpellcastingInst.SpellPointsRemainingEntry,
    ...
    ToolbarAndStatusBarInst.TooltipConfig(StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.InventoryInst.CarryingCapacityEntry, "Left-click on the carrying capacity to set a bonus.")

    # Dice Roller Tooltips
    ToolbarAndStatusBarInst.TooltipConfig(StatsAndDiceRollerFrameInst.DiceRollerInst.DiceNumberEntry, "Scroll the mouse wheel or type to change the number of dice.")
    ToolbarAndStatusBarInst.TooltipConfig(StatsAndDiceRollerFrameInst.DiceRollerInst.DieTypeEntry, "Scroll the mouse wheel or type to change the die type.")
    ToolbarAndStatusBarInst.TooltipConfig(StatsAndDiceRollerFrameInst.DiceRollerInst.ModifierEntry, "Scroll the mouse wheel or type to change the modifier.")
    ToolbarAndStatusBarInst.TooltipConfig(StatsAndDiceRollerFrameInst.DiceRollerInst.ResultsField.ScrolledTextFrame, "Left-click to copy results to the clipboard.  Right-click to clear.")
...
class StatsAndDiceRoller:
    def __init__(self, master):
        ...
        self.StatsAndDiceRollerFrame.grid(row=1, column=0)
    ...
    class CharacterStatsInventoryAndNotes:
            ...
            class AbilitiesAndSavingThrowsTable:
                ...
                class AbilitiesDataConfig:
                    def __init__(self, master):
                        ...
                        # Entries
                        self.StrengthConfigEntry = self.AbilitiesDataConfigEntry(self.Window, StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.AbilitiesAndSkillsInst.AbilitiesAndSavingThrowsInst.StrengthEntry,
                                                                                 self.EntriesList, 1)
                        self.DexterityConfigEntry = self.AbilitiesDataConfigEntry(self.Window, StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.AbilitiesAndSkillsInst.AbilitiesAndSavingThrowsInst.DexterityEntry,
                                                                                  self.EntriesList, 2)
                        ...
                        self.IntelligenceConfigEntry = self.AbilitiesDataConfigEntry(self.Window,
                                                                                     ...
                                                                                     self.EntriesList, 4)
                        self.WisdomConfigEntry = self.AbilitiesDataConfigEntry(self.Window, StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.AbilitiesAndSkillsInst.AbilitiesAndSavingThrowsInst.WisdomEntry,
                                                                               self.EntriesList, 5)
                        self.CharismaConfigEntry = self.AbilitiesDataConfigEntry(self.Window, StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.AbilitiesAndSkillsInst.AbilitiesAndSavingThrowsInst.CharismaEntry,
                                                                                 self.EntriesList, 6)
                        ...
                        self.SubmitButton = Button(self.ButtonsFrame, text="Submit", command=self.Submit, bg=ButtonColor)
                        self.SubmitButton.grid(row=0, column=0, padx=2, pady=2, sticky=NSEW)
                        self.CancelButton = Button(self.ButtonsFrame, text="Cancel", command=self.Cancel, bg=ButtonColor)
            ...
            class FeaturesAndCreatureStats:
                ...
                class FeatureOrCreatureStatsEntry:
                    def __init__(self, master, List, Row):
                        ...
                        # Add Saved Fields to Character Data Dictionary
                        CharacterData["FeatureOrCreatureStatsEntryName" + str(self.Row)] = self.NameEntryVar
                        CharacterData["FeatureEntryDescription" + str(self.Row)] = self.FeatureDescriptionVar
                        CharacterData["CreatureMaxHPEntryVar" + str(self.Row)] = self.MaxHPEntryVar
                        CharacterData["CreatureACEntryVar" + str(self.Row)] = self.ACEntryVar
                        CharacterData["CreatureSpeedEntryVar" + str(self.Row)] = self.SpeedEntryVar
                        CharacterData["CreatureCREntryVar" + str(self.Row)] = self.CREntryVar
                        CharacterData["CreatureSkillSensesAndLanguagesFieldVar" + str(self.Row)] = self.SkillSensesAndLanguagesFieldVar
                        CharacterData["CreatureFeaturesFieldVar" + str(self.Row)] = self.FeaturesFieldVar
                        CharacterData["CreatureActionsAndReactionsFieldVar" + str(self.Row)] = self.ActionsAndReactionsFieldVar
                        CharacterData["CreatureInventoryAndNotesFieldVar" + str(self.Row)] = self.InventoryAndNotesFieldVar
                        CharacterData["CreatureAbilitiesStrengthEntryVar" + str(self.Row)] = self.AbilitiesStrengthEntryVar
                        CharacterData["CreatureAbilitiesDexterityEntryVar" + str(self.Row)] = self.AbilitiesDexterityEntryVar
                        CharacterData["CreatureAbilitiesConstitutionEntryVar" + str(self.Row)] = self.AbilitiesConstitutionEntryVar
                        CharacterData["CreatureAbilitiesIntelligenceEntryVar" + str(self.Row)] = self.AbilitiesIntelligenceEntryVar
                        CharacterData["CreatureAbilitiesWisdomEntryVar" + str(self.Row)] = self.AbilitiesWisdomEntryVar
                        CharacterData["CreatureAbilitiesCharismaEntryVar" + str(self.Row)] = self.AbilitiesCharismaEntryVar
                        CharacterData["CreatureSizeTagsAndAlignmentEntryVar" + str(self.Row)] = self.SizeTagsAndAlignmentEntryVar
                    ...
                    class CreatureStatsConfig:
                        def __init__(self, master, NameEntryVar, SizeTagsAndAlignmentEntryVar, MaxHPEntryVar, ACEntryVar, SpeedEntryVar, CREntryVar, SkillSensesAndLanguagesFieldVar, FeaturesFieldVar, ActionsAndReactionsFieldVar,
                            ...
                            self.SizeTagsAndAlignmentEntry.pack(fill=X, padx=2, pady=2)
                            ...
                            self.MaxHPEntry.pack(fill=X, padx=2, pady=2)
                            ...
                            self.ACEntry.pack(fill=X, padx=2, pady=2)
                            ...
                            self.SpeedEntry.pack(fill=X, padx=2, pady=2)
                            ...
                            self.CREntry.pack(fill=X, padx=2, pady=2)
                            ...
                            self.SkillSensesAndLanguagesField.ScrolledTextFrame.pack()
                            ...
                            self.FeaturesField.ScrolledTextFrame.pack()
                            ...
                            self.ActionsAndReactionsField.ScrolledTextFrame.pack()
                            ...
                            self.InventoryAndNotesField.ScrolledTextFrame.pack()
        ...
        class Spellcasting:
            ...
            class SpellcastingAbility:
                ...
                def RollSpellAttack(self, event):
                    ...
                    StatsAndDiceRollerFrameInst.DiceRollerInst.Roll(self.SpellcastingAbilitySelectionDropdownVar.get() + " Spell Attack:\n")
        ...
        class Inventory:
            def __init__(self, master):
                ...
                self.CarryingCapacityEntry = Entry(self.CarryingCapacityFrame, width=15, justify=CENTER, state=DISABLED, disabledforeground="black", disabledbackground=ButtonColor, textvariable=self.CarryingCapacityVar,
                                                   cursor="arrow")
                ...
                CharacterData["CarryingCapacityManualBonusVar"] = self.CarryingCapacityManualBonusVar
            ...
            def Calculate(self):
                ...
                self.CarryingCapacityVar.set((15 * GetStringVarAsInt(StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.AbilitiesAndSkillsInst.AbilitiesAndSavingThrowsInst.StrengthEntry.AbilityEntryTotalVar)) +
                                             GetStringVarAsInt(self.CarryingCapacityManualBonusVar))
    ...
    class DiceRoller:
        ...
        def __init__(self, master):
            ...
            # Number of Dice
            self.DiceNumberEntry = Entry(self.DiceEntryAndButtonsFrame, textvariable=self.DiceNumberEntryVar, justify=CENTER, width=5, bg=ButtonColor, font=self.DiceEntryFont)
            ...
            self.DieTypeEntry = Entry(self.DiceEntryAndButtonsFrame, textvariable=self.DieTypeEntryVar, justify=CENTER, width=5, bg=ButtonColor, font=self.DiceEntryFont)
            ...
            self.ModifierEntry = Entry(self.DiceEntryAndButtonsFrame, textvariable=self.ModifierEntryVar, justify=CENTER, width=5, bg=ButtonColor, font=self.DiceEntryFont)
            ...
            # Roll Button
            self.RollButton = Button(self.DiceEntryAndButtonsFrame, text="Roll", command=self.Roll, width=7, bg=ButtonColor)
            self.RollButton.grid(row=0, column=5, padx=2, pady=2)

            # Average Roll Button
            self.AverageRollButton = Button(self.DiceEntryAndButtonsFrame, text="Avg. Roll", command=self.AverageRoll, width=7, bg=ButtonColor)
            ...
            self.ResultsField = ScrolledText(self.ResultsFieldFrame, Width=335, Height=154, Disabled=True, DisabledBackground=ButtonColor)
            ...
            # Add Saved Field to Character Data Dictionary
            CharacterData["ResultsField"] = self.ResultsField
        ...
        def MouseWheelEvent(self, event, EntryVar, MinValue=None, MaxValue=None, DieStep=False):
            OldValue = GetStringVarAsInt(EntryVar)
            ...
            if DieStep:
                ...
                if ValueDelta > 0:
                    if NewValue < 4:
                        NewValue = 4
                    elif NewValue > 4 and NewValue < 6:
                        NewValue = 6
            ...
            class PresetRollEntry:
                ...
                class PresetRollModifierConfig:
                    def __init__(self, master, StrengthBoxVar, DexterityBoxVar, ConstitutionBoxVar, IntelligenceBoxVar, WisdomBoxVar, CharismaBoxVar, ProficiencyBoxVar, ManualBonusEntryVar):
                        ...
                        self.ManualBonusEntry.pack(fill=X, padx=2, pady=2)
                        ...
                        self.SubmitButton = Button(self.ButtonsFrame, text="Submit", command=self.Submit, bg=ButtonColor)
                        self.SubmitButton.grid(row=0, column=0, padx=2, pady=2, sticky=NSEW)
                        self.ClearButton = Button(self.ButtonsFrame, text="Clear", command=self.Clear, bg=ButtonColor)
