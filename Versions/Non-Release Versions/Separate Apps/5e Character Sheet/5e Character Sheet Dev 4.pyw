    ...
    class CharacterStatsInventoryAndNotes:
        ...
        class CombatAndFeatures:
            ...
            class Features:
                def __init__(self, master):
                    ...
                    self.FeaturesNotes = ScrolledText(self.FeaturesNotesFrame, Height=120, Width=300)
        ...
        class Spells:
            def __init__(self, master):
                ...
                self.SpellSaveDCEntry = Entry(self.SpellcastingAbilityFrame, state=DISABLED, disabledbackground=ButtonColor, disabledforeground="black", width=2, textvariable=self.SpellSaveDCEntryVar, cursor="arrow")
                ...
                self.SpellAttackModifierEntry = Entry(self.SpellcastingAbilityFrame, state=DISABLED, disabledbackground=ButtonColor, disabledforeground="black", width=2, textvariable=self.SpellAttackModifierEntryVar,
                                                      cursor="arrow")
                ...
                # Spell Slots Rows
                self.SpellSlotsFirstLevel = self.SpellSlotsLevel(self.SpellSlotsFrame, "1st", 1)
                self.SpellSlotsSecondLevel = self.SpellSlotsLevel(self.SpellSlotsFrame, "2nd", 2)
                self.SpellSlotsThirdLevel = self.SpellSlotsLevel(self.SpellSlotsFrame, "3rd", 3)
                self.SpellSlotsFourthLevel = self.SpellSlotsLevel(self.SpellSlotsFrame, "4th", 4)
                self.SpellSlotsFifthLevel = self.SpellSlotsLevel(self.SpellSlotsFrame, "5th", 5)
                self.SpellSlotsSixthLevel = self.SpellSlotsLevel(self.SpellSlotsFrame, "6th", 6)
                self.SpellSlotsSeventhLevel = self.SpellSlotsLevel(self.SpellSlotsFrame, "7th", 7)
                self.SpellSlotsEighthLevel = self.SpellSlotsLevel(self.SpellSlotsFrame, "8th", 8)
                self.SpellSlotsNinthLevel = self.SpellSlotsLevel(self.SpellSlotsFrame, "9th", 9)
                ...
                self.SpellPointsRemainingEntry = Entry(self.SpellPointsFrame, justify=CENTER, width=5, textvariable=self.SpellPointsRemainingEntryVar)
            ...
            class SpellSlotsLevel:
                def __init__(self, master, SlotLevel, Row):
                    self.Row = Row
