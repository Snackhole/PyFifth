...
def ConfigureBindings():
    ...
    #
    # # Features Scrolling
    # StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.CombatAndFeaturesInst.FeaturesAndCreatureStatsInst.FeaturesFrame.bind("<Enter>",
    #                                                                                                                                       StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.CombatAndFeaturesInst.FeaturesAndCreatureStatsInst.FeaturesScrolledCanvas.BindMouseWheel)
    # StatsAndDiceRollerFrameInst.CharacterStatsInventoryAndNotesInst.CombatAndFeaturesInst.FeaturesAndCreatureStatsInst.FeaturesFrame.bind("<Leave>", UnbindMouseWheel)
    #
    # # Inventory Scrolling
