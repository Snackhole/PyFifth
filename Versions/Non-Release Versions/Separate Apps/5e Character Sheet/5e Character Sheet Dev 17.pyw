...
class CharacterStatsInventoryAndNotes:
    ...
    class AbilitiesAndSkills:
        def __init__(self, master):
            ...
            self.PassivePerceptionFrame.grid(row=3, column=1, padx=2, pady=2, sticky=NSEW)
            ...
            self.PassiveInvestigationFrame.grid(row=5, column=1, padx=2, pady=2, sticky=NSEW)
            ...
            # Jack of All Trades
            self.JackOfAllTradesBox = Checkbutton(master, text="Jack of\nAll Trades", variable=self.JackOfAllTradesBoxVar)
            self.JackOfAllTradesBox.grid(row=3, column=3, padx=2, pady=2, sticky=NSEW)

            # Remarkable Athlete
            self.RemarkableAthleteBox = Checkbutton(master, text="Remarkable\nAthlete", variable=self.RemarkableAthleteBoxVar)
            self.RemarkableAthleteBox.grid(row=5, column=3, padx=2, pady=2, sticky=NSEW)
    ...
    class CombatAndFeatures:
        ...
        class ACConfig:
            def __init__(self, master, ACBaseEntryVar, ACModifierVar, ACManualBonusEntryVar):
                ...
                self.Modifier = ttk.Combobox(self.TableFrame, textvariable=self.ModifierVar, values=("", "DEX", "DEX (Max 2)", "DEX + CON", "DEX + WIS"), width=11, state="readonly", justify=CENTER)
...
class DiceRoller:
    def __init__(self, master):
        ...
        # Average Roll Button
        self.AverageRollButton = Button(self.DiceEntryAndButtonsFrame, text="Avg. Roll", command=self.AverageRoll, bg=GlobalInst.ButtonColor)
