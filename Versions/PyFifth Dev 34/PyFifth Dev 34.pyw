...
class CharacterSheet:
            ...
            class FeatureOrCreatureStatsEntry:
                ...
                class FeatureConfig:
                    def __init__(self, master, FeatureVars):
                        ...
                        self.NameEntry = EntryInterceptedBindings(self.NameFrame, justify=CENTER, width=20, textvariable=self.Vars["NameEntryVar"])
    ...
    class Spellcasting:
        def __init__(self, master):
            ...
            # Valid Spell Slot Command Setup
            self.ValidSpellSlotCommand = self.SpellSlotsFrame.register(self.ValidSpellSlotValue)

            # Spell Slots Rows
            self.SpellSlotsFirstLevel = self.SpellSlotsLevel(self.SpellSlotsFrame, self.SpellSlotsList, "1st", 2, self.ValidSpellSlotCommand, 1)
            self.SpellSlotsSecondLevel = self.SpellSlotsLevel(self.SpellSlotsFrame, self.SpellSlotsList, "2nd", 3, self.ValidSpellSlotCommand, 2)
            self.SpellSlotsThirdLevel = self.SpellSlotsLevel(self.SpellSlotsFrame, self.SpellSlotsList, "3rd", 5, self.ValidSpellSlotCommand, 3)
            self.SpellSlotsFourthLevel = self.SpellSlotsLevel(self.SpellSlotsFrame, self.SpellSlotsList, "4th", 6, self.ValidSpellSlotCommand, 4)
            self.SpellSlotsFifthLevel = self.SpellSlotsLevel(self.SpellSlotsFrame, self.SpellSlotsList, "5th", 7, self.ValidSpellSlotCommand, 5)
            self.SpellSlotsSixthLevel = self.SpellSlotsLevel(self.SpellSlotsFrame, self.SpellSlotsList, "6th", 9, self.ValidSpellSlotCommand, 6)
            self.SpellSlotsSeventhLevel = self.SpellSlotsLevel(self.SpellSlotsFrame, self.SpellSlotsList, "7th", 10, self.ValidSpellSlotCommand, 7)
            self.SpellSlotsEighthLevel = self.SpellSlotsLevel(self.SpellSlotsFrame, self.SpellSlotsList, "8th", 11, self.ValidSpellSlotCommand, 8)
            self.SpellSlotsNinthLevel = self.SpellSlotsLevel(self.SpellSlotsFrame, self.SpellSlotsList, "9th", 13, self.ValidSpellSlotCommand, 9)
            ...
            self.SpellPointsRemainingEntry = EntryInterceptedBindings(self.SpellPointsFrame, justify=CENTER, width=5, textvariable=self.SpellPointsRemainingEntryVar, state=DISABLED, disabledbackground=GlobalInst.ButtonColor,
                                                                      disabledforeground="black", cursor="arrow")
            ...
            class SpellListEntry:
                ...
                class SpellConfig:
                    def __init__(self, master, SpellVars):
                        ...
                        self.SchoolEntry = EntryInterceptedBindings(self.SchoolFrame, justify=CENTER, width=10, textvariable=self.Vars["SchoolEntryVar"])
        ...
        class SpellSlotsLevel:
            def __init__(self, master, List, SlotLevel, PointValue, ValidateCommand, Row):
                self.Row = Row
                ...
                # Slots
                self.SlotsEntry = EntryInterceptedBindings(master, width=1, justify=CENTER, textvariable=self.SlotsEntryVar, validate="key", validatecommand=(ValidateCommand, "%P"))
    ...
    class Inventory:
        def __init__(self, master):
            ...
            self.ValidCoinsEntryCommand = self.CoinsInputHolderFrame.register(self.ValidCoinsEntry)
            ...
            self.CoinsEntryCP = EntryInterceptedBindings(self.CoinsInputHolderFrame, width=5, justify=CENTER, textvariable=self.CoinsEntryCPVar, validate="key", validatecommand=(self.ValidCoinsEntryCommand, "%P"))
            ...
            self.CoinsEntrySP = EntryInterceptedBindings(self.CoinsInputHolderFrame, width=5, justify=CENTER, textvariable=self.CoinsEntrySPVar, validate="key", validatecommand=(self.ValidCoinsEntryCommand, "%P"))
            ...
            self.CoinsEntryEP = EntryInterceptedBindings(self.CoinsInputHolderFrame, width=5, justify=CENTER, textvariable=self.CoinsEntryEPVar, validate="key", validatecommand=(self.ValidCoinsEntryCommand, "%P"))
            ...
            self.CoinsEntryGP = EntryInterceptedBindings(self.CoinsInputHolderFrame, width=5, justify=CENTER, textvariable=self.CoinsEntryGPVar, validate="key", validatecommand=(self.ValidCoinsEntryCommand, "%P"))
            ...
            self.CoinsEntryPP = EntryInterceptedBindings(self.CoinsInputHolderFrame, width=5, justify=CENTER, textvariable=self.CoinsEntryPPVar, validate="key", validatecommand=(self.ValidCoinsEntryCommand, "%P"))
        ...
        class InventoryEntry:
            def __init__(self, master, List, ScrollingDisabledVar, SortOrderValuesTuple, Row):
                ...
                # Count Entry
                self.ValidCountCommand = master.register(self.ValidCountEntry)
                self.CountEntry = EntryInterceptedBindings(master, width=4, textvariable=self.CountEntryVar, justify=CENTER, validate="key", validatecommand=(self.ValidCountCommand, "%P"))

                # Unit Weight Entry
                self.ValidWeightCommand = master.register(self.ValidWeightEntry)
                self.UnitWeightEntry = EntryInterceptedBindings(master, width=4, textvariable=self.UnitWeightEntryVar, justify=CENTER, validate="key", validatecommand=(self.ValidWeightCommand, "%P"))

                # Unit Value Entry
                self.ValidValueCommand = master.register(self.ValidValueEntry)
                self.UnitValueEntry = EntryInterceptedBindings(master, width=4, textvariable=self.UnitValueEntryVar, justify=CENTER, validate="key", validatecommand=(self.ValidValueCommand, "%P"))
            ...
            class ItemDescriptionMenu:
                def __init__(self, master, ItemDescriptionVars):
                    ...
                    self.NameFrame.grid_columnconfigure(0, weight=1)
                    self.NameFrame.grid(row=0, column=0, columnspan=2, padx=2, pady=2, sticky=NSEW)
                    self.NameEntry = EntryInterceptedBindings(self.NameFrame, justify=CENTER, width=35, textvariable=self.Vars["NameEntryVar"])
                    ...
                    self.CategoryEntry = EntryInterceptedBindings(self.CategoryFrame, justify=CENTER, textvariable=self.Vars["CategoryEntryVar"], width=15)
                    ...
                    self.RarityEntry = EntryInterceptedBindings(self.RarityFrame, justify=CENTER, textvariable=self.Vars["RarityEntryVar"], width=15)
...
class StatModifier:
    ...
    class ModifierConfig:
        def __init__(self, CurrentVariables, BonusTo, ACMode=False, DiceRollerMode=False):
            ...
            if WindowInst.Mode is "CharacterSheet":
                self.LevelMultiplierEntry = EntryInterceptedBindings(self.TableFrame, justify=CENTER, width=5, textvariable=self.Variables["LevelMultiplierEntryVar"])
            ...
            if WindowInst.Mode is "CharacterSheet":
                self.LevelMinEntry = EntryInterceptedBindings(self.TableFrame, justify=CENTER, width=5, textvariable=self.Variables["LevelMinEntryVar"])
            ...
            if WindowInst.Mode is "CharacterSheet":
                self.LevelMaxEntry = EntryInterceptedBindings(self.TableFrame, justify=CENTER, width=5, textvariable=self.Variables["LevelMaxEntryVar"])
...
class CreatureData:
    def __init__(self, master, DialogMode=False, DialogData=None):
        ...
        if WindowInst.Mode is "NPCSheet":
            ...
            self.ValidProficiencyCommand = self.ProficiencyFrame.register(self.ValidProficiencyEntry)
            self.ProficiencyEntry.configure(validate="key", validatecommand=(self.ValidProficiencyCommand, "%P"))
            self.ProficiencyEntryVar.trace_add("write", lambda a, b, c: self.UpdateStats())

            # Ability Entry Validation
            self.ValidAbilityCommand = self.AbilitiesFrame.register(self.ValidAbilityEntry)
            for AbilityEntryWidget in [self.AbilitiesStrengthEntry, self.AbilitiesDexterityEntry, self.AbilitiesConstitutionEntry, self.AbilitiesIntelligenceEntry, self.AbilitiesWisdomEntry, self.AbilitiesCharismaEntry]:
                AbilityEntryWidget.configure(validate="key", validatecommand=(self.ValidAbilityCommand, "%P"))
