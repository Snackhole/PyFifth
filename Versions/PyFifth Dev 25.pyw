...
class SavingAndOpening:
        ...
        for Field in SavingAndOpeningInst.SavedData.values():
            ...
            if WindowInst.Mode is "CharacterSheet":
                if Field in [CharacterSheetInst.SpellcasterBoxVar, CharacterSheetInst.ConcentrationCheckPromptBoxVar, CharacterSheetInst.PortraitBoxVar]:
                    Field.set(True)
                    continue
            if type(Field) == BooleanVar or type(Field) == SavedBooleanVar:
                Field.set(False)
            else:
                Field.set("")
    ...
    def TrackModifiedFields(self):
        for Field in self.SavedData.values():
            ...
            if FieldType == StringVar or FieldType == SavedStringVar or FieldType == BooleanVar or FieldType == SavedBooleanVar:
...
class CharacterSheet:
    def __init__(self, master):
        ...
        self.CharacterLevelEntryVar = SavedStringVar("CharacterLevelEntryVar")
        ...
        self.CharacterNameEntry = EntryInterceptedBindings(self.CharacterSheetHeaderFrame, textvariable=self.CharacterNameEntryVar, justify=CENTER, width=50)
        ...
        self.CharacterClassEntry = EntryInterceptedBindings(self.CharacterSheetHeaderFrame, textvariable=self.CharacterClassEntryVar, justify=CENTER, width=50)
        ...
        self.CharacterLevelEntry = EntryInterceptedBindings(self.CharacterSheetHeaderFrame, textvariable=self.CharacterLevelEntryVar, width=5, justify=CENTER)
        ...
        self.ProficiencyBonusEntry = EntryInterceptedBindings(self.CharacterSheetHeaderFrame, textvariable=self.ProficiencyBonusEntryVar, state=DISABLED, justify=CENTER, width=5, disabledbackground="light gray",
        ...
        self.CharacterExperienceEntry = EntryInterceptedBindings(self.CharacterSheetHeaderFrame, textvariable=self.CharacterExperienceEntryVar, width=10, justify=CENTER)
        ...
        self.CharacterExperienceNeededEntry = EntryInterceptedBindings(self.CharacterSheetHeaderFrame, textvariable=self.CharacterExperienceNeededEntryVar, state=DISABLED, justify=CENTER, width=10, disabledbackground="light gray",
    ...
    class AbilitiesAndSkills:
        def __init__(self, master):
            ...
            self.PassivePerceptionEntry = EntryInterceptedBindings(self.PassiveScoresFrame, justify=CENTER, width=20, textvariable=self.PassivePerceptionEntryVar)
            ...
            self.PassiveInvestigationEntry = EntryInterceptedBindings(self.PassiveScoresFrame, justify=CENTER, width=20, textvariable=self.PassiveInvestigationEntryVar)
            self.PassiveInvestigationEntry.grid(row=1, column=1, sticky=NSEW)
            self.PassiveInvestigationStatModifierInst = StatModifier(self.PassiveInvestigationEntry, "<Button-1>", "Left-click on Passive Investigation to set a stat modifier.", "Passive Investigation", Prefix="PassiveInvestigation")
        ...
        class AbilitiesAndSavingThrowsTable:
            ...
            class AbilitiesAndSavingThrowsEntry:
                def __init__(self, master, AbilityName, List, Row):
                    ...
                    self.AbilityEntryTotalVar = SavedStringVar(self.AbilityName + "AbilityEntryTotalVar")
                    ...
                    # Config Variables
                    self.AbilityBaseVar = SavedStringVar(self.AbilityName + "AbilityBaseVar")
                    ...
                    # Total Entry
                    self.AbilityEntryTotal = EntryInterceptedBindings(master, width=3, justify=CENTER, textvariable=self.AbilityEntryTotalVar, state=DISABLED, disabledbackground="light gray", disabledforeground="black",
                                                                      cursor="arrow")
                    ...
                    # Modifier Entry
                    self.AbilityEntryModifier = EntryInterceptedBindings(master, width=3, justify=CENTER, textvariable=self.AbilityEntryModifierVar, cursor="dotbox")
                    self.AbilityEntryModifier.grid(row=self.Row, column=2, sticky=NSEW)
                    self.AbilityEntryModifierStatModifierInst = StatModifier(self.AbilityEntryModifier, "<Button-3>", self.AbilityAndSavingThrowTooltipString, self.AbilityName + " Modifier", Cursor="dotbox", Prefix=self.AbilityName + "AbilityEntryModifier")
                    ...
                    self.AbilitySavingThrowModifier = EntryInterceptedBindings(master, width=3, justify=CENTER, textvariable=self.AbilitySavingThrowModifierVar, cursor="dotbox")
                    self.AbilitySavingThrowModifier.grid(row=self.Row, column=5, sticky=NSEW)
                    self.AbilitySavingThrowModifierStatModifierInst = StatModifier(self.AbilitySavingThrowModifier, "<Button-3>", self.AbilityAndSavingThrowTooltipString, self.AbilityName + " Saving Throw", Cursor="dotbox", Prefix=self.AbilityName + "AbilitySavingThrowModifier")
            ...
            class AbilitiesDataConfig:
                def __init__(self, master):
                    ...
                    self.PointBuyEntry = EntryInterceptedBindings(self.Window, state=DISABLED, width=9, disabledbackground="light gray", disabledforeground="black", cursor="arrow", textvariable=self.PointBuyEntryVar,
                                                                  justify=CENTER)
                ...
                class AbilitiesDataConfigEntry:
                    def __init__(self, master, AbilityEntry, AbilityNameShort, List, Row):
                        ...
                        # Base Entry
                        self.AbilityEntryBase = EntryInterceptedBindings(master, width=9, justify=CENTER, textvariable=self.AbilityBaseVar)
                        self.AbilityEntryBase.grid(row=Row, column=1, sticky=NSEW, padx=2, pady=2)

                        # Racial Entry
                        self.AbilityEntryRacial = EntryInterceptedBindings(master, width=9, justify=CENTER, textvariable=self.AbilityRacialVar)
                        self.AbilityEntryRacial.grid(row=Row, column=2, sticky=NSEW, padx=2, pady=2)

                        # ASI Entry
                        self.AbilityEntryASI = EntryInterceptedBindings(master, width=9, justify=CENTER, textvariable=self.AbilityASIVar)
                        self.AbilityEntryASI.grid(row=Row, column=3, sticky=NSEW, padx=2, pady=2)

                        # Misc. Entry
                        self.AbilityEntryMisc = EntryInterceptedBindings(master, width=9, justify=CENTER, textvariable=self.AbilityMiscVar)
                        self.AbilityEntryMisc.grid(row=Row, column=4, sticky=NSEW, padx=2, pady=2)

                        # Override Entry
                        self.AbilityEntryOverride = EntryInterceptedBindings(master, width=9, justify=CENTER, textvariable=self.AbilityOverrideVar)
                        self.AbilityEntryOverride.grid(row=Row, column=5, sticky=NSEW, padx=2, pady=2)

                        # Total Entry
                        self.AbilityEntryTotal = EntryInterceptedBindings(master, width=9, justify=CENTER, state=DISABLED, disabledforeground="black", disabledbackground="light gray", cursor="arrow",
        ...
        class SkillsTable:
            ...
            class SkillsEntry:
                def __init__(self, master, SkillName, List, Row):
                    ...
                    # Modifier
                    self.ModifierEntry = EntryInterceptedBindings(master, textvariable=self.TotalModifierVar, width=3, justify=CENTER, cursor="dotbox")
                    self.ModifierEntry.grid(row=Row, column=2, sticky=NSEW)
                    self.ModifierEntryStatModifierInst = StatModifier(self.ModifierEntry, "<Button-3>", "Left-click on a skill modifier to roll 1d20 with it.  Right-click to set a bonus.", self.SkillName, Cursor="dotbox", Prefix=self.SkillName + "ModifierEntry")
    ...
    class CombatAndFeatures:
        def __init__(self, master):
            ...
            for Index in range(1, 21):
                self.MaxHPData[str(Index)] = SavedStringVar("MaxHPData" + str(Index))
            self.MaxHPData["HPPerLevel"] = SavedStringVar("MaxHPDataHPPerLevel")
            self.MaxHPData["HPOverride"] = SavedStringVar("MaxHPDataHPOverride")
            ...
            self.TempHPEntry = EntryInterceptedBindings(self.TempHPFrame, width=5, justify=CENTER, textvariable=self.TempHPEntryVar, font=self.VitalityFontSize)
            ...
            self.CurrentHPEntry = EntryInterceptedBindings(self.CurrentHPFrame, width=5, justify=CENTER, textvariable=self.CurrentHPEntryVar, bg=GlobalInst.ButtonColor, font=self.VitalityFontSize)
            ...
            self.MaxHPEntry = EntryInterceptedBindings(self.MaxHPFrame, width=5, justify=CENTER, textvariable=self.MaxHPEntryVar, font=self.VitalityFontSize, state=DISABLED, disabledbackground=GlobalInst.ButtonColor,
                                                       cursor="arrow",
                                                       disabledforeground="black")
            ...
            self.HitDiceEntry = EntryInterceptedBindings(self.HitDiceFrame, width=12, justify=CENTER, textvariable=self.HitDiceEntryVar)
            ...
            self.HitDiceRemainingEntry = EntryInterceptedBindings(self.HitDiceRemainingFrame, width=12, justify=CENTER, textvariable=self.HitDiceRemainingEntryVar)
            ...
            self.ACEntry = EntryInterceptedBindings(self.ACFrame, width=9, justify=CENTER, textvariable=self.ACEntryVar, font=self.ACInitiativeSpeedFontSize)
            ...
            self.InitiativeEntry = EntryInterceptedBindings(self.InitiativeFrame, width=9, justify=CENTER, textvariable=self.InitiativeEntryVar, cursor="dotbox", font=self.ACInitiativeSpeedFontSize)
            self.InitiativeEntry.grid(row=0, column=0, sticky=NSEW)
            self.InitiativeEntry.bind("<Button-1>", self.RollInitiative)
            self.InitiativeEntryStatModifierInst = StatModifier(self.InitiativeEntry, "<Button-3>", "Left-click on the initiative modifier to roll 1d20 with it.  Right-click to set a stat modifier.", "Initiative", Cursor="dotbox", Prefix="InitiativeEntry")
            ...
            self.SpeedEntry = EntryInterceptedBindings(self.SpeedFrame, width=9, justify=CENTER, textvariable=self.SpeedEntryVar, font=self.ACInitiativeSpeedFontSize)
        ...
        def SetMaxHPData(self, event):
            ...
            # Create Config Window and Wait
            MaxHPMenuInst = self.MaxHPMenu(WindowInst, self.MaxHPData)
            WindowInst.wait_window(MaxHPMenuInst.Window)

            # Handle Values
            if MaxHPMenuInst.DataSubmitted.get():
                for Tag, Var in self.MaxHPData.items():
        ...
        def CalculateMaxHP(self, ConstitutionModifier, CharacterLevelValue):
            if self.MaxHPData["HPOverride"].get() is not "":
                MaxHP = GlobalInst.GetStringVarAsNumber(self.MaxHPData["HPOverride"])
            else:
                MaxHP = 0
                for Level in range(1, 21):
                    MaxHP += GlobalInst.GetStringVarAsNumber(self.MaxHPData[str(Level)])
                MaxHP += (ConstitutionModifier + GlobalInst.GetStringVarAsNumber(self.MaxHPData["HPPerLevel"])) * CharacterLevelValue
        ...
        class MaxHPMenu:
            def __init__(self, master, MaxHPData):
                ...
                # Instructions
                self.InstructionsLabel = Label(self.Window, text="The HP calculation automatically accounts for your\nConstitution modifier.  Max HP gained at each\nlevel should be based on your hit dice only.", bd=2,
                ...
                self.HPAtEachLevelFirstEntry = EntryInterceptedBindings(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["1"])
                ...
                self.HPAtEachLevelSecondEntry = EntryInterceptedBindings(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["2"])
                ...
                self.HPAtEachLevelThirdEntry = EntryInterceptedBindings(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["3"])
                ...
                self.HPAtEachLevelFourthEntry = EntryInterceptedBindings(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["4"])
                ...
                self.HPAtEachLevelFifthEntry = EntryInterceptedBindings(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["5"])
                ...
                self.HPAtEachLevelSixthEntry = EntryInterceptedBindings(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["6"])
                ...
                self.HPAtEachLevelSeventhEntry = EntryInterceptedBindings(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["7"])
                ...
                self.HPAtEachLevelEighthEntry = EntryInterceptedBindings(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["8"])
                ...
                self.HPAtEachLevelNinthEntry = EntryInterceptedBindings(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["9"])
                ...
                self.HPAtEachLevelTenthEntry = EntryInterceptedBindings(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["10"])
                ...
                self.HPAtEachLevelEleventhEntry = EntryInterceptedBindings(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["11"])
                ...
                self.HPAtEachLevelTwelfthEntry = EntryInterceptedBindings(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["12"])
                ...
                self.HPAtEachLevelThirteenthEntry = EntryInterceptedBindings(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["13"])
                ...
                self.HPAtEachLevelFourteenthEntry = EntryInterceptedBindings(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["14"])
                ...
                self.HPAtEachLevelFifteenthEntry = EntryInterceptedBindings(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["15"])
                ...
                self.HPAtEachLevelSixteenthEntry = EntryInterceptedBindings(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["16"])
                ...
                self.HPAtEachLevelSeventeenthEntry = EntryInterceptedBindings(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["17"])
                ...
                self.HPAtEachLevelEighteenthEntry = EntryInterceptedBindings(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["18"])
                ...
                self.HPAtEachLevelNineteenthEntry = EntryInterceptedBindings(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["19"])
                ...
                self.HPAtEachLevelTwentiethEntry = EntryInterceptedBindings(self.HPAtEachLevelFrame, justify=CENTER, width=self.TableWidgetsWidth, textvariable=self.MaxHPData["20"])
                ...
                self.AdditionalHPPerLevelEntry = EntryInterceptedBindings(self.AdditionalHPPerLevelFrame, textvariable=self.MaxHPData["HPPerLevel"], width=5, justify=CENTER)
                ...
                self.HPOverrideEntry = EntryInterceptedBindings(self.HPOverrideFrame, textvariable=self.MaxHPData["HPOverride"], width=5, justify=CENTER)
        ...
        class FeaturesAndCreatureStats:
            ...
            class FeatureOrCreatureStatsEntry:
                def __init__(self, master, List, ScrollingDisabledVar, SortOrderValuesTuple, Row):
                    ...
                    # Name Entry
                    self.NameEntry = EntryInterceptedBindings(master, width=45, justify=CENTER, state=DISABLED, disabledbackground=GlobalInst.ButtonColor, disabledforeground="black", textvariable=self.NameEntryVar, cursor="arrow")
                ...
                class FeatureConfig:
                    def __init__(self, master, NameEntryVar, DescriptionVar):
                        ...
                        self.NameEntry = EntryInterceptedBindings(self.NameFrame, justify=CENTER, width=20, textvariable=self.NameEntryVar)
    ...
    class Spellcasting:
        def __init__(self, master):
            ...
            self.SpellPointsMaxEntry = EntryInterceptedBindings(self.SpellPointsFrame, justify=CENTER, width=5, cursor="arrow", textvariable=self.SpellPointsMaxEntryVar)
            ...
            self.SpellPointsRemainingEntry = EntryInterceptedBindings(self.SpellPointsFrame, justify=CENTER, width=5, textvariable=self.SpellPointsRemainingEntryVar, state=DISABLED, disabledbackground=GlobalInst.ButtonColor, disabledforeground="black", cursor="arrow")
        ...
        class SpellList:
            ...
            class SpellListEntry:
                def __init__(self, master, List, LevelName, SortOrderValuesTuple, ScrollingDisabledVar, Row):
                    ...
                    # Name Entry
                    self.NameEntry = EntryInterceptedBindings(master.WindowFrame, width=42, justify=CENTER, state=DISABLED, disabledbackground=GlobalInst.ButtonColor, disabledforeground="black", textvariable=self.NameEntryVar,
                                                              cursor="arrow")
                ...
                class SpellConfig:
                    def __init__(self, master, NameEntryVar, SchoolEntryVar, CastingTimeVar, RangeVar, ComponentsVar, DurationVar, DescriptionVar):
                        ...
                        self.SchoolEntry = EntryInterceptedBindings(self.SchoolFrame, justify=CENTER, width=10, textvariable=self.SchoolEntryVar)
        ...
        class SpellSlotsLevel:
            def __init__(self, master, List, SlotLevel, PointValue, Row):
                ...
                # Slots
                self.SlotsEntry = EntryInterceptedBindings(master, width=1, justify=CENTER, textvariable=self.SlotsEntryVar)
                self.SlotsEntry.grid(row=self.Row, column=1, padx=2, pady=2, sticky=NSEW)

                # Used
                self.UsedEntry = EntryInterceptedBindings(master, width=1, justify=CENTER, textvariable=self.UsedEntryVar)
        ...
        class ExpendOrRestoreSpellPointsMenu:
            def __init__(self, master, Mode):
                ...
                self.ManualAmountEntry = EntryInterceptedBindings(self.Window, justify=CENTER, width=5, textvariable=self.ManualAmountEntryVar)
    ...
    class Inventory:
        def __init__(self, master):
            ...
            self.CarryingCapacityEntry = EntryInterceptedBindings(self.CarryingCapacityFrame, width=5, justify=CENTER, textvariable=self.CarryingCapacityVar, cursor="arrow", font=self.CarryingCapacityFont)
            ...
            self.TotalLoadEntry = EntryInterceptedBindings(self.LoadsFrame, width=10, justify=CENTER, state=DISABLED, disabledforeground="black", disabledbackground="light gray", textvariable=self.TotalLoadEntryVar,
                                                           cursor="arrow")
            ...
            self.GearLoadEntry = EntryInterceptedBindings(self.LoadsFrame, width=10, justify=CENTER, state=DISABLED, disabledforeground="black", disabledbackground="light gray", textvariable=self.GearLoadEntryVar, cursor="arrow")
            ...
            self.TreasureLoadEntry = EntryInterceptedBindings(self.LoadsFrame, width=10, justify=CENTER, state=DISABLED, disabledforeground="black", disabledbackground="light gray", textvariable=self.TreasureLoadEntryVar,
                                                              cursor="arrow")
            ...
            self.MiscLoadEntry = EntryInterceptedBindings(self.LoadsFrame, width=10, justify=CENTER, state=DISABLED, disabledforeground="black", disabledbackground="light gray", textvariable=self.MiscLoadEntryVar, cursor="arrow")
            ...
            self.TotalValueEntry = EntryInterceptedBindings(self.ValuesFrame, width=10, justify=CENTER, state=DISABLED, disabledforeground="black", disabledbackground="light gray", textvariable=self.TotalValueEntryVar,
                                                            cursor="arrow")
            ...
            self.GearValueEntry = EntryInterceptedBindings(self.ValuesFrame, width=10, justify=CENTER, state=DISABLED, disabledforeground="black", disabledbackground="light gray", textvariable=self.GearValueEntryVar,
                                                           cursor="arrow")
            ...
            self.TreasureValueEntry = EntryInterceptedBindings(self.ValuesFrame, width=10, justify=CENTER, state=DISABLED, disabledforeground="black", disabledbackground="light gray", textvariable=self.TreasureValueEntryVar,
                                                               cursor="arrow")
            ...
            self.MiscValueEntry = EntryInterceptedBindings(self.ValuesFrame, width=10, justify=CENTER, state=DISABLED, disabledforeground="black", disabledbackground="light gray", textvariable=self.MiscValueEntryVar,
                                                           cursor="arrow")
            ...
            self.CoinsEntryCP = EntryInterceptedBindings(self.CoinsInputHolderFrame, width=5, justify=CENTER, textvariable=self.CoinsEntryCPVar)
            ...
            self.CoinsEntrySP = EntryInterceptedBindings(self.CoinsInputHolderFrame, width=5, justify=CENTER, textvariable=self.CoinsEntrySPVar)
            ...
            self.CoinsEntryEP = EntryInterceptedBindings(self.CoinsInputHolderFrame, width=5, justify=CENTER, textvariable=self.CoinsEntryEPVar)
            ...
            self.CoinsEntryGP = EntryInterceptedBindings(self.CoinsInputHolderFrame, width=5, justify=CENTER, textvariable=self.CoinsEntryGPVar)
            ...
            self.CoinsEntryPP = EntryInterceptedBindings(self.CoinsInputHolderFrame, width=5, justify=CENTER, textvariable=self.CoinsEntryPPVar)
            ...
            self.CoinValueEntry = EntryInterceptedBindings(self.CoinValueAndWeightHolderFrame, width=13, justify=CENTER, textvariable=self.CoinValueEntryVar, state=DISABLED, disabledforeground="black",
            ...
            self.CoinWeightEntry = EntryInterceptedBindings(self.CoinValueAndWeightHolderFrame, width=13, justify=CENTER, textvariable=self.CoinWeightEntryVar, state=DISABLED, disabledforeground="black",
                                                            disabledbackground="light gray",
                                                            cursor="arrow")
        ...
        class SpendCoinsMenu:
            def __init__(self, master, Coins):
                ...
                self.SpendCPEntry = EntryInterceptedBindings(self.SpendFrame, textvariable=self.SpendCPEntryVar, justify=CENTER, width=5)
                self.SpendCPEntry.grid(row=1, column=0, sticky=NSEW, padx=2, pady=2)
                self.SpendSPEntry = EntryInterceptedBindings(self.SpendFrame, textvariable=self.SpendSPEntryVar, justify=CENTER, width=5)
                self.SpendSPEntry.grid(row=1, column=1, sticky=NSEW, padx=2, pady=2)
                self.SpendEPEntry = EntryInterceptedBindings(self.SpendFrame, textvariable=self.SpendEPEntryVar, justify=CENTER, width=5)
                self.SpendEPEntry.grid(row=1, column=2, sticky=NSEW, padx=2, pady=2)
                self.SpendGPEntry = EntryInterceptedBindings(self.SpendFrame, textvariable=self.SpendGPEntryVar, justify=CENTER, width=5)
                self.SpendGPEntry.grid(row=1, column=3, sticky=NSEW, padx=2, pady=2)
                self.SpendPPEntry = EntryInterceptedBindings(self.SpendFrame, textvariable=self.SpendPPEntryVar, justify=CENTER, width=5)
                ...
                self.MatchValuesAfterSpendingEntry = EntryInterceptedBindings(self.MatchValuesFrame, textvariable=self.MatchValuesAfterSpendingEntryVar, width=20, state=DISABLED, disabledforeground="black",
                                                                              disabledbackground="light gray",
                                                                              cursor="arrow", justify=CENTER)
                self.MatchValuesAfterSpendingEntry.grid(row=1, column=0, sticky=NSEW, padx=2, pady=2)
                self.MatchValuesComparatorEntry = EntryInterceptedBindings(self.MatchValuesFrame, textvariable=self.MatchValuesComparatorEntryVar, width=5, state=DISABLED, disabledforeground="black",
                ...
                self.MatchValuesRemainingEntry = EntryInterceptedBindings(self.MatchValuesFrame, textvariable=self.MatchValuesRemainingEntryVar, width=20, state=DISABLED, disabledforeground="black",
                                                                          disabledbackground="light gray",
                                                                          cursor="arrow", justify=CENTER)
                ...
                self.RemainingCPEntry = EntryInterceptedBindings(self.RemainingFrame, textvariable=self.RemainingCPEntryVar, justify=CENTER, width=5)
                self.RemainingCPEntry.grid(row=1, column=0, sticky=NSEW, padx=2, pady=2)
                self.RemainingSPEntry = EntryInterceptedBindings(self.RemainingFrame, textvariable=self.RemainingSPEntryVar, justify=CENTER, width=5)
                self.RemainingSPEntry.grid(row=1, column=1, sticky=NSEW, padx=2, pady=2)
                self.RemainingEPEntry = EntryInterceptedBindings(self.RemainingFrame, textvariable=self.RemainingEPEntryVar, justify=CENTER, width=5)
                self.RemainingEPEntry.grid(row=1, column=2, sticky=NSEW, padx=2, pady=2)
                self.RemainingGPEntry = EntryInterceptedBindings(self.RemainingFrame, textvariable=self.RemainingGPEntryVar, justify=CENTER, width=5)
                self.RemainingGPEntry.grid(row=1, column=3, sticky=NSEW, padx=2, pady=2)
                self.RemainingPPEntry = EntryInterceptedBindings(self.RemainingFrame, textvariable=self.RemainingPPEntryVar, justify=CENTER, width=5)
        ...
        class InventoryEntry:
            def __init__(self, master, List, ScrollingDisabledVar, SortOrderValuesTuple, Row):
                ...
                # Name Entry
                self.NameEntry = EntryInterceptedBindings(master, width=35, textvariable=self.NameEntryVar, justify=CENTER, bg=GlobalInst.ButtonColor)
                ...
                # Count Entry
                self.CountEntry = EntryInterceptedBindings(master, width=4, textvariable=self.CountEntryVar, justify=CENTER)

                # Unit Weight Entry
                self.UnitWeightEntry = EntryInterceptedBindings(master, width=4, textvariable=self.UnitWeightEntryVar, justify=CENTER)

                # Unit Value Entry
                self.UnitValueEntry = EntryInterceptedBindings(master, width=4, textvariable=self.UnitValueEntryVar, justify=CENTER)
                ...
                # Total Weight Entry
                self.TotalWeightEntry = EntryInterceptedBindings(master, width=4, textvariable=self.TotalWeightEntryVar, justify=CENTER, state=DISABLED, disabledforeground="black", disabledbackground="light gray", cursor="arrow")

                # Total Value Entry
                self.TotalValueEntry = EntryInterceptedBindings(master, width=4, textvariable=self.TotalValueEntryVar, justify=CENTER, state=DISABLED, disabledforeground="black", disabledbackground="light gray", cursor="arrow")
            ...
            class ItemDescriptionMenu:
                def __init__(self, master, NameEntryVar, CategoryEntryVar, RarityEntryVar, DescriptionVar):
                    ...
                    self.NameFrame.grid_columnconfigure(0, weight=1)
                    self.NameFrame.grid(row=0, column=0, columnspan=2, padx=2, pady=2, sticky=NSEW)
                    self.NameEntry = EntryInterceptedBindings(self.NameFrame, justify=CENTER, width=35, textvariable=self.NameEntryVar)
                    ...
                    self.CategoryEntry = EntryInterceptedBindings(self.CategoryFrame, justify=CENTER, textvariable=self.CategoryEntryVar, width=15)
                    ...
                    self.RarityEntry = EntryInterceptedBindings(self.RarityFrame, justify=CENTER, textvariable=self.RarityEntryVar, width=15)
        ...
        class SupplyDisplay:
            def __init__(self, master, ConsumptionRateDefault, Tag):
                ...
                # Entries
                self.LoadEntry = EntryInterceptedBindings(self.SupplyDisplayFrame, textvariable=self.LoadEntryVar, width=10, justify=CENTER, state=DISABLED, disabledforeground="black", disabledbackground="light gray",
                                                          cursor="arrow")
                self.LoadEntry.grid(row=0, column=1, sticky=NSEW)
                self.DaysEntry = EntryInterceptedBindings(self.SupplyDisplayFrame, textvariable=self.DaysEntryVar, width=10, justify=CENTER, state=DISABLED, disabledforeground="black", disabledbackground=GlobalInst.ButtonColor,
                                                          cursor="arrow")
            ...
            class ConsumptionRatePrompt:
                def __init__(self, master, ConsumptionRateVar, Tag):
                    ...
                    self.ConsumptionRateEntry = EntryInterceptedBindings(self.TableFrame, width=20, textvariable=self.ConsumptionRateEntryVar, justify=CENTER)
    ...
    class Notes:
        ...
        class AdditionalNotesEntry:
            def __init__(self, master, List, ScrollingDisabledVar, SortOrderValuesTuple, Row):
                ...
                # Name Entry
                self.NameEntry = EntryInterceptedBindings(master, width=28, justify=CENTER, state=DISABLED, disabledbackground=GlobalInst.ButtonColor, disabledforeground="black", textvariable=self.NameEntryVar, cursor="arrow")
    ...
    class PersonalityAndBackstory:
        def __init__(self, master):
            ...
            self.RaceEntry = EntryInterceptedBindings(self.RaceFrame, justify=CENTER, textvariable=self.RaceEntryVar, width=22)
            ...
            self.BackgroundEntry = EntryInterceptedBindings(self.BackgroundFrame, justify=CENTER, textvariable=self.BackgroundEntryVar, width=22)
            ...
            self.AlignmentEntry = EntryInterceptedBindings(self.AlignmentFrame, justify=CENTER, textvariable=self.AlignmentEntryVar, width=22)
            ...
            self.AgeEntry = EntryInterceptedBindings(self.AgeFrame, justify=CENTER, textvariable=self.AgeEntryVar, width=22)
...
class CoinCalculator:
    def __init__(self, master, DialogMode=False):
        ...
        # Input Entries
        self.CPEntry = EntryInterceptedBindings(self.TableFrame, textvariable=self.CPEntryVar, justify=CENTER, width=20)
        self.CPEntry.grid(row=1, column=1, sticky=NSEW)
        self.SPEntry = EntryInterceptedBindings(self.TableFrame, textvariable=self.SPEntryVar, justify=CENTER, width=20)
        self.SPEntry.grid(row=2, column=1, sticky=NSEW)
        self.EPEntry = EntryInterceptedBindings(self.TableFrame, textvariable=self.EPEntryVar, justify=CENTER, width=20)
        self.EPEntry.grid(row=3, column=1, sticky=NSEW)
        self.GPEntry = EntryInterceptedBindings(self.TableFrame, textvariable=self.GPEntryVar, justify=CENTER, width=20)
        self.GPEntry.grid(row=4, column=1, sticky=NSEW)
        self.PPEntry = EntryInterceptedBindings(self.TableFrame, textvariable=self.PPEntryVar, justify=CENTER, width=20)
        self.PPEntry.grid(row=5, column=1, sticky=NSEW)

        # Output Entries
        self.CPOutputEntry = EntryInterceptedBindings(self.TableFrame, textvariable=self.CPOutputEntryVar, justify=CENTER, width=20, state=DISABLED, disabledforeground="black", disabledbackground="light gray", cursor="arrow")
        self.CPOutputEntry.grid(row=1, column=2, sticky=NSEW)
        self.SPOutputEntry = EntryInterceptedBindings(self.TableFrame, textvariable=self.SPOutputEntryVar, justify=CENTER, width=20, state=DISABLED, disabledforeground="black", disabledbackground="light gray", cursor="arrow")
        self.SPOutputEntry.grid(row=2, column=2, sticky=NSEW)
        self.EPOutputEntry = EntryInterceptedBindings(self.TableFrame, textvariable=self.EPOutputEntryVar, justify=CENTER, width=20, state=DISABLED, disabledforeground="black", disabledbackground="light gray", cursor="arrow")
        self.EPOutputEntry.grid(row=3, column=2, sticky=NSEW)
        self.GPOutputEntry = EntryInterceptedBindings(self.TableFrame, textvariable=self.GPOutputEntryVar, justify=CENTER, width=20, state=DISABLED, disabledforeground="black", disabledbackground="light gray", cursor="arrow")
        self.GPOutputEntry.grid(row=4, column=2, sticky=NSEW)
        self.PPOutputEntry = EntryInterceptedBindings(self.TableFrame, textvariable=self.PPOutputEntryVar, justify=CENTER, width=20, state=DISABLED, disabledforeground="black", disabledbackground="light gray", cursor="arrow")
        self.PPOutputEntry.grid(row=5, column=2, sticky=NSEW)
        self.WeightOutputEntry = EntryInterceptedBindings(self.TableFrame, textvariable=self.WeightOutputEntryVar, justify=CENTER, width=20, state=DISABLED, disabledforeground="black", disabledbackground="light gray",
                                                          cursor="arrow")
...
class StatModifier:
    def __init__(self, master, EventString, TooltipText, BonusTo, Cursor="arrow", ACMode=False, Prefix="", Suffix=""):
        # Store Parameters
    ...
    class ModifierConfig:
        def __init__(self, CurrentVariables, BonusTo, ACMode=False):
            ...
            if self.ACMode:
                ...
                self.ACBaseEntry = EntryInterceptedBindings(self.ACBaseFrame, justify=CENTER, width=5, textvariable=self.Variables["ACBaseEntryVar"])
            ...
            # Multiplier Entries
            self.StrengthMultiplierEntry = EntryInterceptedBindings(self.TableFrame, justify=CENTER, width=5, textvariable=self.Variables["StrengthMultiplierEntryVar"])
            self.StrengthMultiplierEntry.grid(row=2, column=1, sticky=NSEW, padx=2, pady=2)
            self.DexterityMultiplierEntry = EntryInterceptedBindings(self.TableFrame, justify=CENTER, width=5, textvariable=self.Variables["DexterityMultiplierEntryVar"])
            self.DexterityMultiplierEntry.grid(row=3, column=1, sticky=NSEW, padx=2, pady=2)
            self.ConstitutionMultiplierEntry = EntryInterceptedBindings(self.TableFrame, justify=CENTER, width=5, textvariable=self.Variables["ConstitutionMultiplierEntryVar"])
            self.ConstitutionMultiplierEntry.grid(row=4, column=1, sticky=NSEW, padx=2, pady=2)
            self.IntelligenceMultiplierEntry = EntryInterceptedBindings(self.TableFrame, justify=CENTER, width=5, textvariable=self.Variables["IntelligenceMultiplierEntryVar"])
            self.IntelligenceMultiplierEntry.grid(row=5, column=1, sticky=NSEW, padx=2, pady=2)
            self.WisdomMultiplierEntry = EntryInterceptedBindings(self.TableFrame, justify=CENTER, width=5, textvariable=self.Variables["WisdomMultiplierEntryVar"])
            self.WisdomMultiplierEntry.grid(row=6, column=1, sticky=NSEW, padx=2, pady=2)
            self.CharismaMultiplierEntry = EntryInterceptedBindings(self.TableFrame, justify=CENTER, width=5, textvariable=self.Variables["CharismaMultiplierEntryVar"])
            self.CharismaMultiplierEntry.grid(row=7, column=1, sticky=NSEW, padx=2, pady=2)
            self.ProficiencyMultiplierEntry = EntryInterceptedBindings(self.TableFrame, justify=CENTER, width=5, textvariable=self.Variables["ProficiencyMultiplierEntryVar"])
            ...
            # Min Entries
            self.StrengthMinEntry = EntryInterceptedBindings(self.TableFrame, justify=CENTER, width=5, textvariable=self.Variables["StrengthMinEntryVar"])
            self.StrengthMinEntry.grid(row=2, column=3, sticky=NSEW, padx=2, pady=2)
            self.DexterityMinEntry = EntryInterceptedBindings(self.TableFrame, justify=CENTER, width=5, textvariable=self.Variables["DexterityMinEntryVar"])
            self.DexterityMinEntry.grid(row=3, column=3, sticky=NSEW, padx=2, pady=2)
            self.ConstitutionMinEntry = EntryInterceptedBindings(self.TableFrame, justify=CENTER, width=5, textvariable=self.Variables["ConstitutionMinEntryVar"])
            self.ConstitutionMinEntry.grid(row=4, column=3, sticky=NSEW, padx=2, pady=2)
            self.IntelligenceMinEntry = EntryInterceptedBindings(self.TableFrame, justify=CENTER, width=5, textvariable=self.Variables["IntelligenceMinEntryVar"])
            self.IntelligenceMinEntry.grid(row=5, column=3, sticky=NSEW, padx=2, pady=2)
            self.WisdomMinEntry = EntryInterceptedBindings(self.TableFrame, justify=CENTER, width=5, textvariable=self.Variables["WisdomMinEntryVar"])
            self.WisdomMinEntry.grid(row=6, column=3, sticky=NSEW, padx=2, pady=2)
            self.CharismaMinEntry = EntryInterceptedBindings(self.TableFrame, justify=CENTER, width=5, textvariable=self.Variables["CharismaMinEntryVar"])
            self.CharismaMinEntry.grid(row=7, column=3, sticky=NSEW, padx=2, pady=2)
            self.ProficiencyMinEntry = EntryInterceptedBindings(self.TableFrame, justify=CENTER, width=5, textvariable=self.Variables["ProficiencyMinEntryVar"])
            self.ProficiencyMinEntry.grid(row=8, column=3, sticky=NSEW, padx=2, pady=2)

            # Max Entries
            self.StrengthMaxEntry = EntryInterceptedBindings(self.TableFrame, justify=CENTER, width=5, textvariable=self.Variables["StrengthMaxEntryVar"])
            self.StrengthMaxEntry.grid(row=2, column=4, sticky=NSEW, padx=2, pady=2)
            self.DexterityMaxEntry = EntryInterceptedBindings(self.TableFrame, justify=CENTER, width=5, textvariable=self.Variables["DexterityMaxEntryVar"])
            self.DexterityMaxEntry.grid(row=3, column=4, sticky=NSEW, padx=2, pady=2)
            self.ConstitutionMaxEntry = EntryInterceptedBindings(self.TableFrame, justify=CENTER, width=5, textvariable=self.Variables["ConstitutionMaxEntryVar"])
            self.ConstitutionMaxEntry.grid(row=4, column=4, sticky=NSEW, padx=2, pady=2)
            self.IntelligenceMaxEntry = EntryInterceptedBindings(self.TableFrame, justify=CENTER, width=5, textvariable=self.Variables["IntelligenceMaxEntryVar"])
            self.IntelligenceMaxEntry.grid(row=5, column=4, sticky=NSEW, padx=2, pady=2)
            self.WisdomMaxEntry = EntryInterceptedBindings(self.TableFrame, justify=CENTER, width=5, textvariable=self.Variables["WisdomMaxEntryVar"])
            self.WisdomMaxEntry.grid(row=6, column=4, sticky=NSEW, padx=2, pady=2)
            self.CharismaMaxEntry = EntryInterceptedBindings(self.TableFrame, justify=CENTER, width=5, textvariable=self.Variables["CharismaMaxEntryVar"])
            self.CharismaMaxEntry.grid(row=7, column=4, sticky=NSEW, padx=2, pady=2)
            self.ProficiencyMaxEntry = EntryInterceptedBindings(self.TableFrame, justify=CENTER, width=5, textvariable=self.Variables["ProficiencyMaxEntryVar"])
            ...
            self.ManualModifierEntry = EntryInterceptedBindings(self.ManualModifierFrame, justify=CENTER, width=5, textvariable=self.Variables["ManualModifierEntryVar"])
...
class AbilityScoreDerivatives:
    def __init__(self, master, List, SaveTagPrefix, Column, AttackTypeStringSuffix=""):
        ...
        # Save DC
        self.SaveDCEntry = EntryInterceptedBindings(master, justify=CENTER, width=2, textvariable=self.SaveDCEntryVar, cursor="arrow")
        ...
        # Attack Modifier
        self.AttackModifierEntry = EntryInterceptedBindings(master, justify=CENTER, width=2, textvariable=self.AttackModifierEntryVar, cursor="dotbox")
        self.AttackModifierEntry.grid(row=2, column=self.Column, padx=2, pady=2, sticky=NSEW)
        self.AttackModifierEntryStatModifierInst = StatModifier(self.AttackModifierEntry, "<Button-3>", "Left-click on an attack modifier to roll 1d20 with it.  Right-click to set a stat modifier.", "Attack Modifier", Cursor="dotbox", Prefix=self.SaveTagPrefix + "AttackModifier", Suffix=str(self.Column))
...
class CreatureData:
    def __init__(self, master, DialogMode=False, DialogData=None):
        ...
        self.NameEntry = EntryInterceptedBindings(self.NameFrame, justify=CENTER, textvariable=self.NameEntryVar)
        self.NameEntry.grid(row=0, column=0, sticky=NSEW, padx=2, pady=2)
        ...
        self.SizeEntry = EntryInterceptedBindings(self.SizeFrame, justify=CENTER, textvariable=self.SizeEntryVar)
        ...
        self.TypeAndTagsEntry = EntryInterceptedBindings(self.TypeAndTagsFrame, justify=CENTER, textvariable=self.TypeAndTagsEntryVar)
        ...
        self.AlignmentEntry = EntryInterceptedBindings(self.AlignmentFrame, justify=CENTER, textvariable=self.AlignmentEntryVar)
        self.AlignmentEntry.grid(row=0, column=0, sticky=NSEW, padx=2, pady=2)
        ...
        self.ProficiencyEntry = EntryInterceptedBindings(self.ProficiencyFrame, justify=CENTER, width=5, textvariable=self.ProficiencyEntryVar)
        ...
        self.TempHPEntry = EntryInterceptedBindings(self.TempHPFrame, justify=CENTER, width=3, textvariable=self.TempHPEntryVar)
        ...
        self.CurrentHPEntry = EntryInterceptedBindings(self.CurrentHPFrame, justify=CENTER, width=3, textvariable=self.CurrentHPEntryVar)
        ...
        self.MaxHPEntry = EntryInterceptedBindings(self.MaxHPFrame, justify=CENTER, width=3, textvariable=self.MaxHPEntryVar)
        ...
        self.ACEntry = EntryInterceptedBindings(self.ACFrame, justify=CENTER, width=3, textvariable=self.ACEntryVar)
        ...
        self.SpeedEntry = EntryInterceptedBindings(self.SpeedFrame, justify=CENTER, width=3, textvariable=self.SpeedEntryVar)
        ...
        self.CRAndExperienceEntry = EntryInterceptedBindings(self.CRAndExperienceFrame, justify=CENTER, width=3, textvariable=self.CRAndExperienceEntryVar)
        ...
        self.AbilitiesStrengthEntry = EntryInterceptedBindings(self.AbilitiesFrame, justify=CENTER, width=5, textvariable=self.AbilitiesStrengthEntryVar)
        ...
        self.AbilitiesDexterityEntry = EntryInterceptedBindings(self.AbilitiesFrame, justify=CENTER, width=5, textvariable=self.AbilitiesDexterityEntryVar)
        ...
        self.AbilitiesConstitutionEntry = EntryInterceptedBindings(self.AbilitiesFrame, justify=CENTER, width=5, textvariable=self.AbilitiesConstitutionEntryVar)
        ...
        self.AbilitiesIntelligenceEntry = EntryInterceptedBindings(self.AbilitiesFrame, justify=CENTER, width=5, textvariable=self.AbilitiesIntelligenceEntryVar)
        ...
        self.AbilitiesWisdomEntry = EntryInterceptedBindings(self.AbilitiesFrame, justify=CENTER, width=5, textvariable=self.AbilitiesWisdomEntryVar)
        ...
        self.AbilitiesCharismaEntry = EntryInterceptedBindings(self.AbilitiesFrame, justify=CENTER, width=5, textvariable=self.AbilitiesCharismaEntryVar)
        ...
        self.VulnerabilitiesResistancesAndImmunitiesField = ScrolledText(self.VulnerabilitiesResistancesAndImmunitiesFrame, Width=383, Height=75, SavedDataTag="VulnerabilitiesResistancesAndImmunitiesFieldVar" if not DialogMode else None)
...
class DiceRoller:
    def __init__(self, master):
        ...
        # Number of Dice
        self.DiceNumberEntry = EntryInterceptedBindings(self.DiceEntryAndButtonsFrame, textvariable=self.DiceNumberEntryVar, justify=CENTER, width=5, bg=GlobalInst.ButtonColor, font=self.DiceEntryFont)
        ...
        self.DieTypeEntry = EntryInterceptedBindings(self.DiceEntryAndButtonsFrame, textvariable=self.DieTypeEntryVar, justify=CENTER, width=5, bg=GlobalInst.ButtonColor, font=self.DiceEntryFont)
        ...
        self.ModifierEntry = EntryInterceptedBindings(self.DiceEntryAndButtonsFrame, textvariable=self.ModifierEntryVar, justify=CENTER, width=5, bg=GlobalInst.ButtonColor, font=self.DiceEntryFont)
        ...
        self.CritMinimumEntry = EntryInterceptedBindings(self.CritMinimumFrame, textvariable=self.CritMinimumEntryVar, justify=CENTER, width=5)
    ...
    class PresetRolls:
        ...
        class PresetRollEntry:
            def __init__(self, master, List, ScrollingDisabledVar, SortOrderValuesTuple, DiceRollerFields, Row):
                ...
                # Name
                self.PresetRollNameEntry = EntryInterceptedBindings(master, justify=CENTER, width=33, textvariable=self.PresetRollNameEntryVar)

                # Roll Button
                self.PresetRollButton = Button(master, text="Roll:", command=self.RollPreset, bg=GlobalInst.ButtonColor)

                # Dice Number
                self.PresetRollDiceNumberEntry = EntryInterceptedBindings(master, justify=CENTER, width=5, textvariable=self.PresetRollDiceNumberEntryVar)

                # Die Type
                self.PresetRollDieTypeLabel = Label(master, text="d")
                self.PresetRollDieTypeEntry = EntryInterceptedBindings(master, justify=CENTER, width=5, textvariable=self.PresetRollDieTypeEntryVar)

                # Modifier
                self.PresetRollModifierButton = Label(master, text="+")
                self.PresetRollModifierEntry = EntryInterceptedBindings(master, justify=CENTER, width=5, textvariable=self.PresetRollModifierEntryVar)
...
class EncounterHeader:
    def __init__(self, master):
        ...
        self.EncounterNameEntry = EntryInterceptedBindings(self.EncounterHeaderFrame, textvariable=self.EncounterNameEntryVar, justify=CENTER, width=30)
        ...
        self.CREntry = EntryInterceptedBindings(self.EncounterHeaderFrame, textvariable=self.CREntryVar, justify=CENTER, width=5)
        ...
        self.ExperienceEntry = EntryInterceptedBindings(self.EncounterHeaderFrame, textvariable=self.ExperienceEntryVar, justify=CENTER, width=10)
...
class InitiativeOrder:
    def __init__(self, master):
        ...
        self.RoundEntry = EntryInterceptedBindings(self.RoundFrame, textvariable=self.RoundEntryVar, font=self.InitiativeDataFont, width=5, justify=CENTER)
    ...
    class InitiativeEntry:
        def __init__(self, master, List, ScrollingDisabledVar, Row):
            ...
            # Initiative Entry
            self.InitiativeEntryResultEntry = EntryInterceptedBindings(self.master, textvariable=self.InitiativeEntryResultEntryVar, justify=CENTER, width=5, bg=GlobalInst.ButtonColor)
            ...
            # Name Entry
            self.InitiativeEntryNameEntry = EntryInterceptedBindings(self.master, textvariable=self.InitiativeEntryNameEntryVar, justify=CENTER, width=35, bg=GlobalInst.ButtonColor)
            ...
            # AC Entry
            self.InitiativeEntryACEntry = EntryInterceptedBindings(self.master, textvariable=self.InitiativeEntryACEntryVar, justify=CENTER, width=5)

            # Temp HP Entry
            self.InitiativeEntryTempHPEntry = EntryInterceptedBindings(self.master, textvariable=self.InitiativeEntryTempHPEntryVar, justify=CENTER, width=5)

            # Current HP Entry
            self.InitiativeEntryCurrentHPEntry = EntryInterceptedBindings(self.master, textvariable=self.InitiativeEntryCurrentHPEntryVar, justify=CENTER, width=5, bg=GlobalInst.ButtonColor)
            ...
            # Max HP Entry
            self.InitiativeEntryMaxHPEntry = EntryInterceptedBindings(self.master, textvariable=self.InitiativeEntryMaxHPEntryVar, justify=CENTER, width=5)
...
class EntryInterceptedBindings(Entry):
    def __init__(self, *args, **kwargs):
...
class IntegerPrompt:
    def __init__(self, master, WindowTitle, Header, MinValue=None, MaxValue=None):
        ...
        self.IntegerEntry = EntryInterceptedBindings(self.TableFrame, width=20, textvariable=self.IntegerEntryVar, justify=CENTER)
...
class StringPrompt:
    def __init__(self, master, WindowTitle, Header):
        ...
        self.StringEntry = EntryInterceptedBindings(self.TableFrame, width=20, textvariable=self.StringEntryVar, justify=CENTER)
...
class ModeSelect(Tk):
    def __init__(self):
        ...
        # Configure Window
        self.wm_title("Select Mode - PyFifth " + GlobalInst.Version)
        ...
        self.DiceRollerModeButton.grid(row=1, column=0, sticky=NSEW, padx=2, pady=2)
        ...
        self.EncounterManagerModeButton.grid(row=1, column=1, sticky=NSEW, padx=2, pady=2)
        ...
        self.CompactInitiativeModeButton.grid(row=2, column=0, sticky=NSEW, padx=2, pady=2)
        ...
        self.NPCSheetModeButton.grid(row=2, column=1, sticky=NSEW, padx=2, pady=2)
        ...
        self.CreatureDataUtilityModeButton.grid(row=3, column=0, sticky=NSEW, padx=2, pady=2)
        ...
        self.CoinCalculatorModeButton.grid(row=3, column=1, sticky=NSEW, padx=2, pady=2)
...
if __name__ == "__main__":
    ...
    # Window Titles
    WindowTitles = {}
    WindowTitles["CharacterSheet"] = "Character Sheet - PyFifth " + GlobalInst.Version
    WindowTitles["DiceRoller"] = "Dice Roller - PyFifth " + GlobalInst.Version
    WindowTitles["EncounterManager"] = "Encounter Manager - PyFifth " + GlobalInst.Version
    WindowTitles["CompactInitiativeOrder"] = "Compact Initiative Order - PyFifth " + GlobalInst.Version
    WindowTitles["CreatureDataUtility"] = "Creature Data Utility - PyFifth " + GlobalInst.Version
    WindowTitles["CoinCalculator"] = "Coin Calculator - PyFifth " + GlobalInst.Version
    WindowTitles["NPCSheet"] = "NPC Sheet - PyFifth " + GlobalInst.Version
