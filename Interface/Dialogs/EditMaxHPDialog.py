...
from PyQt6.QtWidgets import QDialog, QSizePolicy, QLabel, QPushButton, QGridLayout, QSpinBox
...
class EditMaxHPDialog(QDialog):
    def __init__(self, CharacterWindow):
        ...
        self.BonusMaxHPPerLevelLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.BonusMaxHPPerLevelSpinBox = QSpinBox()
        self.BonusMaxHPPerLevelSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.BonusMaxHPPerLevelSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.BonusMaxHPPerLevelSpinBox.setButtonSymbols(self.BonusMaxHPPerLevelSpinBox.ButtonSymbols.NoButtons)
        ...
        self.MaxHPOverrideLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPOverrideSpinBox = QSpinBox()
        self.MaxHPOverrideSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPOverrideSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.MaxHPOverrideSpinBox.setButtonSymbols(self.MaxHPOverrideSpinBox.ButtonSymbols.NoButtons)
    ...
    def CreateMaxHPGainedAtEachLevel(self):
        ...
        self.MaxHPGainedAtEachLevelLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAtEachLevelLabel.setFrameStyle(QLabel.Shape.StyledPanel | QLabel.Shadow.Plain)
        self.MaxHPGainedAtEachLevelLabel.setMargin(5)

        # 1st Level
        self.MaxHPGainedAt1stLevelLabel = QLabel("1st")
        self.MaxHPGainedAt1stLevelLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt1stLevelSpinBox = QSpinBox()
        self.MaxHPGainedAt1stLevelSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt1stLevelSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.MaxHPGainedAt1stLevelSpinBox.setButtonSymbols(self.MaxHPGainedAt1stLevelSpinBox.ButtonSymbols.NoButtons)
        ...
        self.MaxHPGainedAt2ndLevelLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt2ndLevelSpinBox = QSpinBox()
        self.MaxHPGainedAt2ndLevelSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt2ndLevelSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.MaxHPGainedAt2ndLevelSpinBox.setButtonSymbols(self.MaxHPGainedAt2ndLevelSpinBox.ButtonSymbols.NoButtons)
        ...
        self.MaxHPGainedAt3rdLevelLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt3rdLevelSpinBox = QSpinBox()
        self.MaxHPGainedAt3rdLevelSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt3rdLevelSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.MaxHPGainedAt3rdLevelSpinBox.setButtonSymbols(self.MaxHPGainedAt3rdLevelSpinBox.ButtonSymbols.NoButtons)
        ...
        self.MaxHPGainedAt4thLevelLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt4thLevelSpinBox = QSpinBox()
        self.MaxHPGainedAt4thLevelSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt4thLevelSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.MaxHPGainedAt4thLevelSpinBox.setButtonSymbols(self.MaxHPGainedAt4thLevelSpinBox.ButtonSymbols.NoButtons)
        ...
        self.MaxHPGainedAt5thLevelLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt5thLevelSpinBox = QSpinBox()
        self.MaxHPGainedAt5thLevelSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt5thLevelSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.MaxHPGainedAt5thLevelSpinBox.setButtonSymbols(self.MaxHPGainedAt5thLevelSpinBox.ButtonSymbols.NoButtons)
        ...
        self.MaxHPGainedAt6thLevelLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt6thLevelSpinBox = QSpinBox()
        self.MaxHPGainedAt6thLevelSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt6thLevelSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.MaxHPGainedAt6thLevelSpinBox.setButtonSymbols(self.MaxHPGainedAt6thLevelSpinBox.ButtonSymbols.NoButtons)
        ...
        self.MaxHPGainedAt7thLevelLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt7thLevelSpinBox = QSpinBox()
        self.MaxHPGainedAt7thLevelSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt7thLevelSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.MaxHPGainedAt7thLevelSpinBox.setButtonSymbols(self.MaxHPGainedAt7thLevelSpinBox.ButtonSymbols.NoButtons)
        ...
        self.MaxHPGainedAt8thLevelLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt8thLevelSpinBox = QSpinBox()
        self.MaxHPGainedAt8thLevelSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt8thLevelSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.MaxHPGainedAt8thLevelSpinBox.setButtonSymbols(self.MaxHPGainedAt8thLevelSpinBox.ButtonSymbols.NoButtons)
        ...
        self.MaxHPGainedAt9thLevelLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt9thLevelSpinBox = QSpinBox()
        self.MaxHPGainedAt9thLevelSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt9thLevelSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.MaxHPGainedAt9thLevelSpinBox.setButtonSymbols(self.MaxHPGainedAt9thLevelSpinBox.ButtonSymbols.NoButtons)
        ...
        self.MaxHPGainedAt10thLevelLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt10thLevelSpinBox = QSpinBox()
        self.MaxHPGainedAt10thLevelSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt10thLevelSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.MaxHPGainedAt10thLevelSpinBox.setButtonSymbols(self.MaxHPGainedAt10thLevelSpinBox.ButtonSymbols.NoButtons)
        ...
        self.MaxHPGainedAt11thLevelLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt11thLevelSpinBox = QSpinBox()
        self.MaxHPGainedAt11thLevelSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt11thLevelSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.MaxHPGainedAt11thLevelSpinBox.setButtonSymbols(self.MaxHPGainedAt11thLevelSpinBox.ButtonSymbols.NoButtons)
        ...
        self.MaxHPGainedAt12thLevelLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt12thLevelSpinBox = QSpinBox()
        self.MaxHPGainedAt12thLevelSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt12thLevelSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.MaxHPGainedAt12thLevelSpinBox.setButtonSymbols(self.MaxHPGainedAt12thLevelSpinBox.ButtonSymbols.NoButtons)
        ...
        self.MaxHPGainedAt13thLevelLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt13thLevelSpinBox = QSpinBox()
        self.MaxHPGainedAt13thLevelSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt13thLevelSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.MaxHPGainedAt13thLevelSpinBox.setButtonSymbols(self.MaxHPGainedAt13thLevelSpinBox.ButtonSymbols.NoButtons)
        ...
        self.MaxHPGainedAt14thLevelLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt14thLevelSpinBox = QSpinBox()
        self.MaxHPGainedAt14thLevelSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt14thLevelSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.MaxHPGainedAt14thLevelSpinBox.setButtonSymbols(self.MaxHPGainedAt14thLevelSpinBox.ButtonSymbols.NoButtons)
        ...
        self.MaxHPGainedAt15thLevelLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt15thLevelSpinBox = QSpinBox()
        self.MaxHPGainedAt15thLevelSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt15thLevelSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.MaxHPGainedAt15thLevelSpinBox.setButtonSymbols(self.MaxHPGainedAt15thLevelSpinBox.ButtonSymbols.NoButtons)
        ...
        self.MaxHPGainedAt16thLevelLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt16thLevelSpinBox = QSpinBox()
        self.MaxHPGainedAt16thLevelSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt16thLevelSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.MaxHPGainedAt16thLevelSpinBox.setButtonSymbols(self.MaxHPGainedAt16thLevelSpinBox.ButtonSymbols.NoButtons)
        ...
        self.MaxHPGainedAt17thLevelLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt17thLevelSpinBox = QSpinBox()
        self.MaxHPGainedAt17thLevelSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt17thLevelSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.MaxHPGainedAt17thLevelSpinBox.setButtonSymbols(self.MaxHPGainedAt17thLevelSpinBox.ButtonSymbols.NoButtons)
        ...
        self.MaxHPGainedAt18thLevelLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt18thLevelSpinBox = QSpinBox()
        self.MaxHPGainedAt18thLevelSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt18thLevelSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.MaxHPGainedAt18thLevelSpinBox.setButtonSymbols(self.MaxHPGainedAt18thLevelSpinBox.ButtonSymbols.NoButtons)
        ...
        self.MaxHPGainedAt19thLevelLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt19thLevelSpinBox = QSpinBox()
        self.MaxHPGainedAt19thLevelSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt19thLevelSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.MaxHPGainedAt19thLevelSpinBox.setButtonSymbols(self.MaxHPGainedAt19thLevelSpinBox.ButtonSymbols.NoButtons)
        ...
        self.MaxHPGainedAt20thLevelLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt20thLevelSpinBox = QSpinBox()
        self.MaxHPGainedAt20thLevelSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MaxHPGainedAt20thLevelSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.MaxHPGainedAt20thLevelSpinBox.setButtonSymbols(self.MaxHPGainedAt20thLevelSpinBox.ButtonSymbols.NoButtons)
