...
from PyQt6.QtWidgets import QDialog, QGridLayout, QSizePolicy, QPushButton, QSpinBox, QLabel, QMessageBox
...
class SpendCoinsDialog(QDialog):
    def __init__(self, ParentWindow):
        ...
        self.SpendLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.SpendLabel.setFrameStyle(QLabel.Shape.StyledPanel | QLabel.Shadow.Plain)
        self.SpendLabel.setMargin(5)

        # Spent Coins Header Labels
        self.SpentCPLabel = QLabel("CP")
        self.SpentCPLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.SpentCPLabel.setFrameStyle(QLabel.Shape.StyledPanel | QLabel.Shadow.Plain)
        self.SpentCPLabel.setMargin(5)
        self.SpentSPLabel = QLabel("SP")
        self.SpentSPLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.SpentSPLabel.setFrameStyle(QLabel.Shape.StyledPanel | QLabel.Shadow.Plain)
        self.SpentSPLabel.setMargin(5)
        self.SpentEPLabel = QLabel("EP")
        self.SpentEPLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.SpentEPLabel.setFrameStyle(QLabel.Shape.StyledPanel | QLabel.Shadow.Plain)
        self.SpentEPLabel.setMargin(5)
        self.SpentGPLabel = QLabel("GP")
        self.SpentGPLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.SpentGPLabel.setFrameStyle(QLabel.Shape.StyledPanel | QLabel.Shadow.Plain)
        self.SpentGPLabel.setMargin(5)
        self.SpentPPLabel = QLabel("PP")
        self.SpentPPLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.SpentPPLabel.setFrameStyle(QLabel.Shape.StyledPanel | QLabel.Shadow.Plain)
        self.SpentPPLabel.setMargin(5)

        # Spent Coins Spin Boxes
        self.SpentCPSpinBox = QSpinBox()
        self.SpentCPSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.SpentCPSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.SpentCPSpinBox.setButtonSymbols(self.SpentCPSpinBox.ButtonSymbols.NoButtons)
        ...
        self.SpentSPSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.SpentSPSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.SpentSPSpinBox.setButtonSymbols(self.SpentSPSpinBox.ButtonSymbols.NoButtons)
        ...
        self.SpentEPSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.SpentEPSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.SpentEPSpinBox.setButtonSymbols(self.SpentEPSpinBox.ButtonSymbols.NoButtons)
        ...
        self.SpentGPSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.SpentGPSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.SpentGPSpinBox.setButtonSymbols(self.SpentGPSpinBox.ButtonSymbols.NoButtons)
        ...
        self.SpentPPSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.SpentPPSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.SpentPPSpinBox.setButtonSymbols(self.SpentPPSpinBox.ButtonSymbols.NoButtons)
        ...
        self.MatchValuesLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.MatchValuesLabel.setFrameStyle(QLabel.Shape.StyledPanel | QLabel.Shadow.Plain)
        self.MatchValuesLabel.setMargin(5)

        # Value After Spending Label
        self.ValueAfterSpendingLabel = QLabel("Value After Spending (CP):")
        self.ValueAfterSpendingLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.ValueAfterSpendingLabel.setFrameStyle(QLabel.Shape.StyledPanel | QLabel.Shadow.Plain)
        self.ValueAfterSpendingLabel.setMargin(5)

        # Value After Spending Spin Box
        self.ValueAfterSpendingSpinBox = QSpinBox()
        self.ValueAfterSpendingSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.ValueAfterSpendingSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.ValueAfterSpendingSpinBox.setButtonSymbols(self.ValueAfterSpendingSpinBox.ButtonSymbols.NoButtons)
        self.ValueAfterSpendingSpinBox.setRange(0, 1000000000)
        self.ValueAfterSpendingSpinBox.setReadOnly(True)
        self.ValueAfterSpendingSpinBox.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        ...
        self.EqualityLineEdit.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)

        # Remaining Coins Value Label
        self.RemainingCoinsValueLabel = QLabel("Remaining Coins Value (CP):")
        self.RemainingCoinsValueLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.RemainingCoinsValueLabel.setFrameStyle(QLabel.Shape.StyledPanel | QLabel.Shadow.Plain)
        self.RemainingCoinsValueLabel.setMargin(5)

        # Remaining Coins Value Spin Box
        self.RemainingCoinsValueSpinBox = QSpinBox()
        self.RemainingCoinsValueSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.RemainingCoinsValueSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.RemainingCoinsValueSpinBox.setButtonSymbols(self.RemainingCoinsValueSpinBox.ButtonSymbols.NoButtons)
        self.RemainingCoinsValueSpinBox.setRange(0, 1000000000)
        self.RemainingCoinsValueSpinBox.setReadOnly(True)
        self.RemainingCoinsValueSpinBox.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)

        # Remaining Label
        self.RemainingLabel = QLabel("Remaining Coins")
        self.RemainingLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.RemainingLabel.setFrameStyle(QLabel.Shape.StyledPanel | QLabel.Shadow.Plain)
        self.RemainingLabel.setMargin(5)

        # Remaining Coins Header Labels
        self.RemainingCPLabel = QLabel("CP")
        self.RemainingCPLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.RemainingCPLabel.setFrameStyle(QLabel.Shape.StyledPanel | QLabel.Shadow.Plain)
        self.RemainingCPLabel.setMargin(5)
        self.RemainingSPLabel = QLabel("SP")
        self.RemainingSPLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.RemainingSPLabel.setFrameStyle(QLabel.Shape.StyledPanel | QLabel.Shadow.Plain)
        self.RemainingSPLabel.setMargin(5)
        self.RemainingEPLabel = QLabel("EP")
        self.RemainingEPLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.RemainingEPLabel.setFrameStyle(QLabel.Shape.StyledPanel | QLabel.Shadow.Plain)
        self.RemainingEPLabel.setMargin(5)
        self.RemainingGPLabel = QLabel("GP")
        self.RemainingGPLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.RemainingGPLabel.setFrameStyle(QLabel.Shape.StyledPanel | QLabel.Shadow.Plain)
        self.RemainingGPLabel.setMargin(5)
        self.RemainingPPLabel = QLabel("PP")
        self.RemainingPPLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.RemainingPPLabel.setFrameStyle(QLabel.Shape.StyledPanel | QLabel.Shadow.Plain)
        self.RemainingPPLabel.setMargin(5)

        # Remaining Coins Spin Boxes
        self.RemainingCPSpinBox = QSpinBox()
        self.RemainingCPSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.RemainingCPSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.RemainingCPSpinBox.setButtonSymbols(self.RemainingCPSpinBox.ButtonSymbols.NoButtons)
        ...
        self.RemainingSPSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.RemainingSPSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.RemainingSPSpinBox.setButtonSymbols(self.RemainingSPSpinBox.ButtonSymbols.NoButtons)
        ...
        self.RemainingEPSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.RemainingEPSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.RemainingEPSpinBox.setButtonSymbols(self.RemainingEPSpinBox.ButtonSymbols.NoButtons)
        ...
        self.RemainingGPSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.RemainingGPSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.RemainingGPSpinBox.setButtonSymbols(self.RemainingGPSpinBox.ButtonSymbols.NoButtons)
        ...
        self.RemainingPPSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.RemainingPPSpinBox.setSizePolicy(self.InputsSizePolicy)
        self.RemainingPPSpinBox.setButtonSymbols(self.RemainingPPSpinBox.ButtonSymbols.NoButtons)
    ...
    def ValidEntry(self, Alert=False):
        ...
        if CPValueAfterSpending != RemainingCoinsCPValue:
            if Alert:
                self.ParentWindow.DisplayMessageBox("The value of your coins after spending must be equal to the value of your remaining coins.", Icon=QMessageBox.Icon.Warning, Parent=self)
            return False
        return True
